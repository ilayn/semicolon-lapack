 ...
 *
 * Usage:
 *   ./bench_dgetrf_fortran [n] [iterations]    Single size benchmark
 *   ./bench_dgetrf_fortran --sweep              Sweep n=32..4096, print table
 *   ./bench_dgetrf_fortran --sweep --csv        Same but CSV output
 *
 * Profiling:
 *   samply record ./bench_dgetrf_fortran 1000 50
 */
...
int main(int argc, char* argv[])
{
    ...
    if (do_sweep) {
        ...
        if (do_csv) {
            ...
            printf("Benchmarking vendor dgetrf_: n=%d, iterations=%d (warmup=%d)\n",
