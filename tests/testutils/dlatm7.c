/**
 * @file dlatm7.c
 * @brief DLATM7 computes the entries of D as specified by MODE, COND, IRSIGN.
 *
 * DLATM7 is called by DLATMT to generate random test matrices.
 */
    ...
    if (mode != 0) {
        ...
        switch (absmode) {
            ...
            case 3:
                ...
                d[0] = ONE;
                if (n > 1 && rank > 1) {
                    alpha = pow(cond, -ONE / (double)(rank - 1));
                    for (i = 1; i < rank; i++) {
