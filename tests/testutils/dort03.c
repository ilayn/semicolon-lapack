/**
 * @file dort03.c
 * @brief DORT03 compares two orthogonal matrices U and V to see if their
 *        corresponding rows or columns span the same spaces.
 *
 * Port of LAPACK's TESTING/EIG/dort03.f to C.
 */
