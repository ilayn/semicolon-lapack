...
extern void dsytrf_rk(const char* uplo, const int n, f64* A, const int lda,
                      f64* E, int* ipiv, f64* work, const int lwork,
                      int* info);
extern void dsytri_3(const char* uplo, const int n, f64* A, const int lda,
                     const f64* E, const int* ipiv, f64* work,
                     const int lwork, int* info);
extern void dsytrs_3(const char* uplo, const int n, const int nrhs,
                     const f64* A, const int lda, const f64* E,
                     const int* ipiv, f64* B, const int ldb, int* info);
extern void dsycon_3(const char* uplo, const int n, const f64* A,
                     const int lda, const f64* E, const int* ipiv,
                     const f64 anorm, f64* rcond, f64* work,
                     int* iwork, int* info);

/* Verification routines */
extern void dsyt01_3(const char* uplo, const int n, const f64* A,
                     const int lda, f64* AFAC, const int ldafac,
                     f64* E, int* ipiv, f64* C, const int ldc,
                     f64* rwork, f64* resid);
...
typedef struct {
    ...
    f64* E;      /* Superdiagonal/subdiagonal of D (RK-specific) */
...
static int group_setup(void** state)
{
    ...
    g_workspace->E = malloc(NMAX * sizeof(f64));
