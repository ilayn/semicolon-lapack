 ...
 *
 * Tests DGGSVD3 - the GSVD for M-by-N matrix A and P-by-N matrix B:
...
/* Number of test results per call to dgsvts3 */
#define NTESTS 6
...
static void test_dckgsv_case(void** state)
{
    ...
    dgsvts3(m, p, n, g_ws->A, g_ws->AF, lda, g_ws->B, g_ws->BF, ldb,
...
int main(void)
{
    ...
    (void)_cmocka_run_group_tests("dckgsv", g_tests, g_num_tests,
