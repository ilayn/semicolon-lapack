...
L630:
    ...
    for (INT iuplo = 0; iuplo <= 1; iuplo++) {
        ...
        if (iinfo != 0) {
            fprintf(stderr, "DSYEV_2STAGE(N,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L660;
        }
...
L660:
        ...
        dsyevx_2stage("N", "A", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m2,
               ...
               iwork + 5 * n, &iinfo);
        if (iinfo != 0) {
            fprintf(stderr, "DSYEVX_2STAGE(N,A,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L680;
        }
...
L680:
        ...
        dsyevx_2stage("N", "I", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m3,
               ...
               iwork + 5 * n, &iinfo);
        if (iinfo != 0) {
            fprintf(stderr, "DSYEVX_2STAGE(N,I,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L690;
        }
...
L690:
        ...
        dsyevx_2stage("N", "V", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m3,
               ...
               iwork + 5 * n, &iinfo);
        if (iinfo != 0) {
            fprintf(stderr, "DSYEVX_2STAGE(N,V,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L700;
        }
...
L1080:
        ...
        if (iinfo != 0) {
            fprintf(stderr, "DSBEV_2STAGE(N,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L1180;
        }
...
L1180:
        ...
        if (iinfo != 0) {
            fprintf(stderr, "DSBEVX_2STAGE(N,A,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L1280;
        }
...
L1280:
        ...
        dsbevx_2stage("N", "I", uplo, n, kd, V, ldu, U, ldu, vl, vu, il, iu,
               abstol, &m3, WA3, Z, ldu, work, ws->lwork, iwork, iwork + 5 * n, &iinfo);
        if (iinfo != 0) {
            fprintf(stderr, "DSBEVX_2STAGE(N,I,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L1370;
        }
...
L1370:
        ...
        dsbevx_2stage("N", "V", uplo, n, kd, V, ldu, U, ldu, vl, vu, il, iu,
               abstol, &m3, WA3, Z, ldu, work, ws->lwork, iwork, iwork + 5 * n, &iinfo);
        if (iinfo != 0) {
            fprintf(stderr, "DSBEVX_2STAGE(N,V,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L1460;
        }
...
L1460:
        ...
        if (iinfo != 0) {
            fprintf(stderr, "DSYEVD_2STAGE(N,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L1480;
        }
...
L1580:
        ...
        dsbevd_2stage("N", uplo, n, kd, V, ldu, D3, Z, ldu, work, ws->lwork,
               iwork, liwedc, &iinfo);
        if (iinfo != 0) {
            fprintf(stderr, "DSBEVD_2STAGE(N,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L1680;
        }
...
L1680:
        ...
        dsyevr_2stage("N", "A", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m2,
               ...
               iwork + 2 * n, ws->liwork - 2 * n, &iinfo);
        if (iinfo != 0) {
            fprintf(stderr, "DSYEVR_2STAGE(N,A,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L1700;
        }
...
L1700:
        ...
        dsyevr_2stage("N", "I", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m3,
               ...
               iwork + 2 * n, ws->liwork - 2 * n, &iinfo);
        if (iinfo != 0) {
            fprintf(stderr, "DSYEVR_2STAGE(N,I,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L1710;
        }
...
L1710:
        ...
        dsyevr_2stage("N", "V", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m3,
               ...
               iwork + 2 * n, ws->liwork - 2 * n, &iinfo);
        if (iinfo != 0) {
            fprintf(stderr, "DSYEVR_2STAGE(N,V,%s) returned info=%d\n", uplo, iinfo);
            ws->result[ntest - 1] = ulpinv;
            goto L1750;
        }
...
int main(void)
{
    ...
    (void)_cmocka_run_group_tests("ddrvst2stg", g_tests, g_num_tests,
