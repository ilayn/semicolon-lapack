 ...
 *   Chain 1: dense -> RFP -> packed -> dense  (DTRTTF, DTFTTP, DTPTTR)
 *   Chain 2: dense -> packed -> RFP -> dense  (DTRTTP, DTPTTF, DTFTTR)
 *
...
int main(void)
{
    ...
    (void)_cmocka_run_group_tests("ddrvrf2", g_tests, g_num_tests, NULL, NULL);
    return 0;
}
