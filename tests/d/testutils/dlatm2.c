/**
 * @file dlatm2.c
 * @brief DLATM2 returns the (I,J) entry of a random matrix.
 *
 * Faithful port of LAPACK TESTING/MATGEN/dlatm2.f
 */
 ...
 *
 * Use of DLATM2 differs from DLATM3 in the order in which the random
 ...
 * @param[in] i       Row of entry to be returned (1-based).
 * @param[in] j       Column of entry to be returned (1-based).
