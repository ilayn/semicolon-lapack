/**
 * @file dgsvts3.c
 * @brief DGSVTS3 tests DGGSVD3 for the GSVD of two matrices.
 */
 ...
 * @param[out]    AF      Copy of A, overwritten by DGGSVD3.
 * @param[in]     lda     Leading dimension of A and AF. lda >= max(1,m).
 * @param[in]     B       The P-by-N matrix B.
 * @param[out]    BF      Copy of B, overwritten by DGGSVD3.
             ...
             f64* result)
{
    ...
    dggsvd3("U", "V", "Q", m, n, p, &k, &l, AF, lda, BF, ldb,
    ...
    dlaset("F", m, m, ZERO, ONE, work, ldu);
