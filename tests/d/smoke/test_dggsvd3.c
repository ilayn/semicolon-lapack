/**
 * @file test_dggsvd3.c
 * @brief CMocka test suite for dggsvd3 (Generalized Singular Value Decomposition).
 *
 * Tests the GSVD routine dggsvd3 using LAPACK's verification methodology
 * with normalized residuals via dgsvts3.
 *
 * Verification (6 tests from dgsvts3):
