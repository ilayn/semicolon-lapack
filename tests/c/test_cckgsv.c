 ...
 *
 * Tests CGGSVD3 - the GSVD for M-by-N matrix A and P-by-N matrix B:
...
static int group_setup(void** state)
{
    ...
    g_ws->A     = malloc(NMAX * NMAX * sizeof(c64));
    g_ws->AF    = malloc(NMAX * NMAX * sizeof(c64));
    g_ws->B     = malloc(NMAX * NMAX * sizeof(c64));
    g_ws->BF    = malloc(NMAX * NMAX * sizeof(c64));
    g_ws->U     = malloc(NMAX * NMAX * sizeof(c64));
    g_ws->V     = malloc(NMAX * NMAX * sizeof(c64));
    g_ws->Q     = malloc(NMAX * NMAX * sizeof(c64));
    g_ws->R     = malloc(NMAX * NMAX * sizeof(c64));
...
static void test_zckgsv_case(void** state)
{
    ...
    cgsvts3(m, p, n, g_ws->A, g_ws->AF, lda, g_ws->B, g_ws->BF, ldb,
