...
L130:
        ...
        ntest = ntest + 2;
        cheevx("N", "A", uplo, n, A, ldu, vl, vu, il, iu,
...
L150:
        ...
        cheevx("N", "I", uplo, n, A, ldu, vl, vu, il, iu,
...
L160:
        ...
        cheevx("N", "V", uplo, n, A, ldu, vl, vu, il, iu,
               abstol, &m3, WA3, Z, ldu, work, ws->lwork, rwork,
               iwork, iwork + 5 * n, &iinfo);
        if (iinfo != 0) {
...
L650:
        ...
        chbevx("N", "A", uplo, n, kd, V, ldu, U, ldu, vl,
...
L750:
        ...
        chbevx("N", "I", uplo, n, kd, V, ldu, U, ldu, vl,
...
L840:
        ...
        chbevx("N", "V", uplo, n, kd, V, ldu, U, ldu, vl,
               vu, il, iu, abstol, &m3, WA3, Z, ldu, work,
               rwork, iwork, iwork + 5 * n, &iinfo);
        if (iinfo != 0) {
...
L1140:
        ...
        ntest = ntest + 2;
        cheevr("N", "A", uplo, n, A, ldu, vl, vu, il, iu,
...
L1170:
        ...
        ntest = ntest + 2;
        clacpy(" ", n, n, V, ldu, A, lda);
        cheevr("N", "I", uplo, n, A, ldu, vl, vu, il, iu,
...
L1180:
        ...
        ntest = ntest + 2;
        clacpy(" ", n, n, V, ldu, A, lda);
        cheevr("N", "V", uplo, n, A, ldu, vl, vu, il, iu,
               abstol, &m3, WA3, Z, ldu, iwork, work, ws->lwork,
               rwork, ws->lrwork, iwork + 2 * n, ws->liwork - 2 * n,
               &iinfo);
        if (iinfo != 0) {
