/**
 * @file cgeqls.c
 * @brief CGEQLS solves the least squares problem min || A*X - B || using the
 *        QL factorization A = Q*L computed by CGEQLF.
 */
 ...
 *                       as returned by CGEQLF. Complex*16 array, dimension
 *                       (lda, n).
    ...
    INT* info)
{
    ...
    *info = 0;
    ...
    cunmql("L", "C", m, nrhs, n, A, lda, tau, B, ldb, work, lwork, info);
