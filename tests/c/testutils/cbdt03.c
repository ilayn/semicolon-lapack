/**
 * @file cbdt03.c
 * @brief CBDT03 reconstructs a bidiagonal matrix B from its SVD
 *        and computes the residual.
 *
 * Port of LAPACK's TESTING/EIG/cbdt03.f to C.
 */
    ...
    if (kd >= 1) {
        ...
        if (uplo[0] == 'U' || uplo[0] == 'u') {
            ...
            for (j = 0; j < n; j++) {
                ...
                cblas_cgemv(CblasColMajor, CblasNoTrans, n, n, &CNEGONE, U, ldu,
                ...
                f32 colsum = cblas_scasum(n, work, 1);
                if (colsum > *resid)
                    *resid = colsum;
            }
        } else {
