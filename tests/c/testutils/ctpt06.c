/**
 * @file ctpt06.c
 * @brief CTPT06 compares condition number estimates for a triangular matrix
 *        in packed format.
 *
 * Port of LAPACK TESTING/LIN/ctpt06.f to C.
 */
 ...
 * computed by CTPCON. Information about the triangular matrix A is
 ...
 * @param[in]     rcondc  The estimate of the reciprocal condition number from CTPCON.
            ...
            const c64* AP, f32* rwork, f32* rat)
{
    const f32 ZERO = 0.0f;
    const f32 ONE = 1.0f;
    f32 anorm, bignum, eps, rmax, rmin;
