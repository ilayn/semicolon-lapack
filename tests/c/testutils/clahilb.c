/**
 * @file clahilb.c
 * @brief CLAHILB generates an N by N scaled Hilbert matrix in A along with
 *        NRHS right-hand sides in B and solutions in X such that A*X=B.
 *
 * Faithful port of LAPACK TESTING/MATGEN/clahilb.f
 */
...
static const c64 D1[8] = {
    CMPLXF(-1.0f, 0.0f),  CMPLXF(0.0f, 1.0f), CMPLXF(-1.0f, -1.0f),
     CMPLXF(0.0f, -1.0f),  CMPLXF(1.0f, 0.0f), CMPLXF(-1.0f, 1.0f),
     CMPLXF(1.0f, 1.0f),  CMPLXF(1.0f, -1.0f)
};

static const c64 D2[8] = {
    CMPLXF(-1.0f, 0.0f),  CMPLXF(0.0f, -1.0f), CMPLXF(-1.0f, 1.0f),
     CMPLXF(0.0f, 1.0f),  CMPLXF(1.0f, 0.0f), CMPLXF(-1.0f, -1.0f),
     CMPLXF(1.0f, -1.0f),  CMPLXF(1.0f, 1.0f)
};

static const c64 INVD1[8] = {
    CMPLXF(-1.0f, 0.0f),  CMPLXF(0.0f, -1.0f), CMPLXF(-0.5f, 0.5f),
     CMPLXF(0.0f, 1.0f),  CMPLXF(1.0f, 0.0f), CMPLXF(-0.5f, -0.5f),
     CMPLXF(0.5f, -0.5f),  CMPLXF(0.5f, 0.5f)
};

static const c64 INVD2[8] = {
    CMPLXF(-1.0f, 0.0f),  CMPLXF(0.0f, 1.0f), CMPLXF(-0.5f, -0.5f),
     CMPLXF(0.0f, -1.0f),  CMPLXF(1.0f, 0.0f), CMPLXF(-0.5f, 0.5f),
     CMPLXF(0.5f, 0.5f),  CMPLXF(0.5f, -0.5f)
};
 ...
 */
void clahilb(const INT n, const INT nrhs,
             c64* A, const INT lda,
             c64* X, const INT ldx,
             c64* B, const INT ldb,
             f32* work, INT* info,
             const char* path)
{
    ...
    *info = 0;
     ...
     * identity. */
    tmp = (f32)m;
    claset("Full", n, nrhs, CMPLXF(0.0f, 0.0f), tmp, B, ldb);
