/**
 * @file clatm1.c
 * @brief CLATM1 computes the entries of D(1..N) as specified by MODE, COND
 *        and IRSIGN.
 *
 * Faithful port of LAPACK TESTING/MATGEN/clatm1.f
