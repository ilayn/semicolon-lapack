/**
 * @file cpbt02.c
 * @brief CPBT02 computes the residual for a solution of a Hermitian banded
 *        system of equations A*x = b.
 *
 * Port of LAPACK TESTING/LIN/cpbt02.f
 */
            ...
            f32* rwork, f32* resid)
{
    ...
    *resid = ZERO;
    ...
    c64 alpha = CMPLXF(-1.0f, 0.0f);
    c64 beta  = CMPLXF(1.0f, 0.0f);

    for (INT j = 0; j < nrhs; j++) {
        cblas_chbmv(CblasColMajor, cblas_uplo, n, kd, &alpha, A, lda,
