 ...
 *   Chain 1: dense -> RFP -> packed -> dense  (CTRTTF, CTFTTP, CTPTTR)
 *   Chain 2: dense -> packed -> RFP -> dense  (CTRTTP, CTPTTF, CTFTTR)
 *
...
int main(void)
{
    ...
    return _cmocka_run_group_tests("zdrvrf2", g_tests, g_num_tests, NULL, NULL);
}
