...
static int group_setup(void** state)
{
    ...
    /* CHEGV_2STAGE workspace: lwmin = n + lhtrd + lwtrd where
...
int main(void)
{
    ...
    (void)_cmocka_run_group_tests("zdrvsg2stg", g_tests, g_num_tests,
