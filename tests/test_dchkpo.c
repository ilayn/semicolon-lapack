...
extern void dporfs(const char* uplo, const int n, const int nrhs,
                   ...
                   const int ldaf, const f64* B, const int ldb,
                   f64* X, const int ldx, f64* ferr, f64* berr,
                   f64* work, int* iwork, int* info);
extern void dpocon(const char* uplo, const int n, const f64* A,
                   const int lda, const f64 anorm, f64* rcond,
                   f64* work, int* iwork, int* info);

/* Verification routines */
extern void dpot01(const char* uplo, const int n, const f64* A,
