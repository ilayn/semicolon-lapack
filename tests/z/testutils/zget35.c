...
void zget35(f64* rmax, INT* lmax, INT* ninfo, INT* knt)
{
    ...
    /* Test case 1: M=1, N=1 */
    static const c128 atmp1[1] = {2.0 + 0.0*I};
    static const c128 btmp1[1] = {2.0 + 0.0*I};
    static const c128 ctmp1[1] = {1.0 + 1.0*I};

    /* Test case 2: M=1, N=3 */
    static const c128 atmp2[1] = {1.0 + 1.0*I};
    static const c128 btmp2[3*3] = {
        /* col 0 */  1.0 + 1.0*I,  0.0 + 0.0*I,  0.0 + 0.0*I,
        /* col 1 */  1.0 + 1.0*I,  1.5 + 1.5*I,  0.0 + 0.0*I,
        /* col 2 */  1.0 + 1.0*I,  2.0 + 1.0*I,  2.0 + 2.0*I
    };
    static const c128 ctmp2[1*3] = {
        2.0 + 1.0*I,  2.0 + 1.0*I,  9.0 + 0.0*I
    };
    ...
    static const c128 ctmp3[4*4] = {
        /* col 0 */  1.0+0.0*I,  2.0+0.0*I,  0.0+0.0*I,  0.0+7.0*I,
        /* col 1 */  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,
        /* col 2 */  2.0+0.0*I,  8.0+9.0*I,  0.0+0.0*I,  2.0+0.0*I,
        /* col 3 */  1.0+3.0*I,  2.0+2.0*I,  0.0+0.0*I,  1.0+0.0*I
    };
    ...
    static const c128 atmp7[4*4] = {
        1.0+0.0*I, 0.0+0.0*I, 0.0+0.0*I, 0.0+0.0*I,
        0.0+1.0*I, 1.0+0.0*I, 0.0+0.0*I, 0.0+0.0*I,
        0.0+1.0*I, 0.0+1.0*I, 1.0+0.0*I, 0.0+0.0*I,
        0.0+0.0*I, 0.0+0.0*I, 0.0+1.0*I, 1.0+0.0*I
    };
    static const c128 btmp7[4*4] = {
       -1.0+1.0*I, 0.0+0.0*I, 0.0+0.0*I, 0.0+0.0*I,
        0.0+1.0*I,-1.0+0.0*I, 0.0+0.0*I, 0.0+0.0*I,
        0.0+0.0*I, 0.0+1.0*I,-1.0+0.0*I, 0.0+0.0*I,
        0.0+1.0*I, 0.0+0.0*I, 0.0+1.0*I,-1.0+0.0*I
    };
    ...
    static const c128 atmp8[4*4] = {
        0.0621+0.7054*I, 0.0+0.0*I,        0.0+0.0*I,        0.0+0.0*I,
        0.1062+0.0503*I, 0.2640+0.5782*I,  0.0+0.0*I,        0.0+0.0*I,
        0.6553+0.5876*I, 0.9700+0.7256*I,  0.0380+0.2849*I,  0.0+0.0*I,
        0.2560+0.8642*I, 0.5598+0.1943*I,  0.9166+0.0580*I,  0.1402+0.6908*I
    };
    static const c128 btmp8[3*3] = {
        0.6769+0.6219*I, 0.0+0.0*I,        0.0+0.0*I,
        0.5965+0.0505*I, 0.0726+0.7195*I,  0.0+0.0*I,
        0.7361+0.5069*I, 0.2531+0.9764*I,  0.3481+0.5602*I
    };
    static const c128 ctmp8[4*3] = {
        0.9110+0.7001*I, 0.0728+0.5887*I, 0.1729+0.6041*I, 0.3785+0.7924*I,
        0.1821+0.5406*I, 0.3271+0.5647*I, 0.9368+0.3514*I, 0.6588+0.8646*I,
        0.8879+0.5813*I, 0.3793+0.1667*I, 0.8149+0.3535*I, 0.1353+0.8362*I
    };

    /* Test case 9: M=6, N=5 */
    static const c128 atmp9[6*6] = {
        /* col 0 */
         3.0+ 5.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,
        /* col 1 */
         3.0+22.0*I, -3.0+5.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,
        /* col 2 */
         2.0+ 3.0*I,  3.0+2.0*I,  3.0+2.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,
        /* col 3 */
         2.0+ 3.0*I,  2.0+3.0*I,  2.0+3.0*I,-33.0+2.0*I,  0.0+0.0*I,  0.0+0.0*I,
        /* col 4 */
         3.0+ 3.0*I,  2.0+3.0*I,  2.0+3.0*I,  2.0+3.0*I,-22.0+3.0*I,  0.0+0.0*I,
        /* col 5 */
       311.0+ 2.0*I, 11.0+2.0*I,  1.0-2.0*I,  1.0+2.0*I,  1.0+2.0*I,  2.0-3.0*I
    };
    static const c128 btmp9[5*5] = {
        /* col 0 */
         9.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,
        /* col 1 */
         2.0+0.0*I,-19.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,
        /* col 2 */
       -12.0+0.0*I, 12.0+0.0*I, 98.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,
        /* col 3 */
         1.0+0.0*I,  1.0+0.0*I, 11.0+0.0*I, 13.0+0.0*I,  0.0+0.0*I,
        /* col 4 */
         3.0+0.0*I,  3.0+0.0*I,  3.0+0.0*I, 11.0+0.0*I, 13.0+0.0*I
    };
    static const c128 ctmp9[6*5] = {
        ...
        /* col 1 */
         3.0+22.0*I,-3.0+5.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,
        /* col 2 */
         2.0+31.0*I, 33.0+22.0*I,-3.0+2.0*I,  0.0+0.0*I,  0.0+0.0*I,  0.0+0.0*I,
        /* col 3 */
         2.0+ 3.0*I,  2.0+3.0*I,  2.0+3.0*I,-33.0+2.0*I,  0.0+0.0*I,  0.0+0.0*I,
        /* col 4 */
         3.0+ 3.0*I, -2.0+3.0*I,  2.0-3.0*I,  2.0+3.0*I,-22.0+3.0*I,  0.0-2.0*I
    };
