/**
 * @file zsyt01_rook.c
 * @brief ZSYT01_ROOK reconstructs a complex symmetric indefinite matrix A from its
 *        block L*D*L' or U*D*U' factorization (Rook pivoting) and computes the residual.
 *
 * Port of LAPACK TESTING/LIN/zsyt01_rook.f to C.
 */
 ...
 * @param[in]     ipiv    The pivot indices from ZSYTRF_ROOK. Integer array, dimension (n).
 *                        0-based indexing.
