/**
 * @file zlatb5.c
 * @brief ZLATB5 sets parameters for the matrix generator based on the type of
...
/**
 * ZLATB5 sets parameters for the matrix generator based on the type of
 * matrix to be generated.
 *
 ...
 * @param[out] anorm   The desired norm of the matrix to be generated.
