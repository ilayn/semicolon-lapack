 ...
 *
 * Tests ZGGLSE - the linear equality constrained least squares solver:
...
static int group_setup(void** state)
{
    ...
    g_ws->C     = malloc(NMAX * sizeof(c128));
    g_ws->CF    = malloc(NMAX * sizeof(c128));
    g_ws->D     = malloc(NMAX * sizeof(c128));
    g_ws->DF    = malloc(NMAX * sizeof(c128));
    g_ws->X     = malloc(NMAX * sizeof(c128));
...
int main(void)
{
    ...
    return _cmocka_run_group_tests("zcklse", g_tests, g_num_tests,
