...
extern void sorhr_col01(const int m, const int n, const int mb1, const int nb1,
                        const int nb2, f32* restrict result);
extern void sorhr_col02(const int m, const int n, const int mb1, const int nb1,
                        const int nb2, f32* restrict result);
