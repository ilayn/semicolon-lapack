...
extern void ssyev_2stage(const char* jobz, const char* uplo, const int n,
                         f32* A, const int lda, f32* W, f32* work,
                         const int lwork, int* info);
extern void ssyevd_2stage(const char* jobz, const char* uplo, const int n,
                          f32* A, const int lda, f32* W, f32* work,
                          const int lwork, int* iwork, const int liwork, int* info);
extern void ssyevx_2stage(const char* jobz, const char* range, const char* uplo,
                          const int n, f32* A, const int lda, const f32 vl,
                          const f32 vu, const int il, const int iu,
                          const f32 abstol, int* m, f32* W, f32* Z,
                          const int ldz, f32* work, const int lwork, int* iwork,
                          int* ifail, int* info);
extern void ssyevr_2stage(const char* jobz, const char* range, const char* uplo,
                          const int n, f32* A, const int lda, const f32 vl,
                          const f32 vu, const int il, const int iu,
                          const f32 abstol, int* m, f32* W, f32* Z,
                          const int ldz, int* isuppz, f32* work, const int lwork,
...
extern void ssbev_2stage(const char* jobz, const char* uplo, const int n,
                         const int kd, f32* AB, const int ldab, f32* W,
                         f32* Z, const int ldz, f32* work, const int lwork,
                         int* info);
extern void ssbevd_2stage(const char* jobz, const char* uplo, const int n,
                          const int kd, f32* AB, const int ldab, f32* W,
                          f32* Z, const int ldz, f32* work, const int lwork,
                          int* iwork, const int liwork, int* info);
extern void ssbevx_2stage(const char* jobz, const char* range, const char* uplo,
                          const int n, const int kd, f32* AB, const int ldab,
                          f32* Q, const int ldq, const f32 vl, const f32 vu,
                          const int il, const int iu, const f32 abstol, int* m,
                          f32* W, f32* Z, const int ldz, f32* work,
...
static int group_setup(void** state)
{
     ...
     * Query ssyevr_2stage (most demanding) to get the required size. */
    {
        f32 work_query;
        int iwork_query;
        int info_query;
        ssyevr_2stage("N", "A", "L", nmax, NULL, nmax, 0.0f, 0.0f, 0, 0,
                      0.0f, NULL, NULL, NULL, nmax, NULL, &work_query, -1,
...
L660:
        ...
        ssyevx_2stage("N", "A", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m2,
...
L680:
        ...
        ssyevx_2stage("N", "I", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m3,
...
L690:
        ...
        ssyevx_2stage("N", "V", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m3,
               WA3, Z, ldu, work, ws->lwork, iwork,
               iwork + 5 * n, &iinfo);
        if (iinfo != 0) {
...
L1680:
        ...
        ssyevr_2stage("N", "A", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m2,
               WA2, Z, ldu, iwork, work, ws->lwork,
               iwork + 2 * n, ws->liwork - 2 * n, &iinfo);
        if (iinfo != 0) {
...
L1700:
        ...
        ssyevr_2stage("N", "I", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m3,
               WA3, Z, ldu, iwork, work, ws->lwork,
               iwork + 2 * n, ws->liwork - 2 * n, &iinfo);
        if (iinfo != 0) {
...
L1710:
        ...
        ssyevr_2stage("N", "V", uplo, n, A, ldu, vl, vu, il, iu, abstol, &m3,
               WA3, Z, ldu, iwork, work, ws->lwork,
               iwork + 2 * n, ws->liwork - 2 * n, &iinfo);
        if (iinfo != 0) {
