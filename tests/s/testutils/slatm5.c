/**
 * @file slatm5.c
 * @brief SLATM5 generates matrices involved in the Generalized Sylvester equation.
 */
    ...
    if (prtype == 1) {
        ...
        for (i = 0; i < m; i++) {
            for (j = 0; j < n; j++) {
                ...
                R[i + j * ldr] = (HALF - sinf((f32)((i + 1) / (j + 1)))) * TWENTY;
                L[i + j * ldl] = R[i + j * ldr];
            }
        }
        ...
        for (i = 0; i < m; i++) {
            for (j = 0; j < m; j++) {
                if (i <= j) {
                    A[i + j * lda] = (HALF - sinf((f32)(i + 1))) * TWO;
                    D[i + j * ldd] = (HALF - sinf((f32)((i + 1) * (j + 1)))) * TWO;
                } else {
                    A[i + j * lda] = ZERO;
                    D[i + j * ldd] = ZERO;
                }
        ...
        for (i = 0; i < n; i++) {
            for (j = 0; j < n; j++) {
                if (i <= j) {
                    B[i + j * ldb] = (HALF - sinf((f32)((i + 1) + (j + 1)))) * TWO;
                    E[i + j * lde] = (HALF - sinf((f32)(j + 1))) * TWO;
                } else {
                    B[i + j * ldb] = ZERO;
                    E[i + j * lde] = ZERO;
                }
        ...
        for (i = 0; i < m; i++) {
            for (j = 0; j < n; j++) {
                R[i + j * ldr] = (HALF - sinf((f32)((i + 1) * (j + 1)))) * TWENTY;
                L[i + j * ldl] = (HALF - sinf((f32)((i + 1) + (j + 1)))) * TWENTY;
            }
        }
        ...
        for (i = 0; i < m; i++) {
            for (j = 0; j < m; j++) {
                A[i + j * lda] = (HALF - sinf((f32)((i + 1) * (j + 1)))) * TWENTY;
                D[i + j * ldd] = (HALF - sinf((f32)((i + 1) + (j + 1)))) * TWO;
            }
        }
        ...
        for (i = 0; i < n; i++) {
            for (j = 0; j < n; j++) {
                B[i + j * ldb] = (HALF - sinf((f32)((i + 1) + (j + 1)))) * TWENTY;
                E[i + j * lde] = (HALF - sinf((f32)((i + 1) * (j + 1)))) * TWO;
            }
        }
        ...
        for (i = 0; i < m; i++) {
            for (j = 0; j < n; j++) {
                ...
                R[i + j * ldr] = (HALF - sinf((f32)((j + 1) / (i + 1)))) * TWENTY;
                L[i + j * ldl] = (HALF - sinf((f32)((i + 1) * (j + 1)))) * TWO;
            }
        }
        ...
        for (i = 0; i < m; i++) {
            for (j = 0; j < n; j++) {
                R[i + j * ldr] = (HALF - sinf((f32)((i + 1) * (j + 1)))) * alpha / TWENTY;
                L[i + j * ldl] = (HALF - sinf((f32)((i + 1) + (j + 1)))) * alpha / TWENTY;
            }
        }
