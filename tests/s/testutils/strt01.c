/**
 * @file strt01.c
 * @brief STRT01 computes the residual for a triangular matrix A times its inverse.
 *
 * Port of LAPACK TESTING/LIN/strt01.f to C.
 */
            ...
            f32* rcond, f32* work, f32* resid)
{
    ...
    *resid = slantr("1", uplo, "N", n, n, AINV, ldainv, work);
