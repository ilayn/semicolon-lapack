/**
 * @file slatmt.c
 * @brief SLATMT generates random matrices with specified singular values.
 *
 * Faithful port of LAPACK TESTING/MATGEN/slatmt.f
 */
 ...
 *
 * SLATMT operates by applying the following sequence of operations:
 *
            ...
            uint64_t state[static 4])
{
    ...
    *info = 0;
    ...
    givens = 0;
    if (isym == 1) {
        if ((f32)(llb + uub) < 0.3f * (f32)((mr + nc > 1) ? mr + nc : 1)) {
            givens = 1;
        }
    } else {
        if (2 * llb < m) {
                        ...
                        for (jch = jr - jkl; jch >= 1; jch -= jkl + jku) {
                            ...
                            if (iltemp) {
                                ...
                                extra = ZERO;
                                {
                                    ...
                                    slarot(1, jch > jku + jkl ? 1 : 0, 1, il, c, -s,
                        ...
                        for (jch = jc - jku; jch >= 1; jch -= jkl + jku) {
                            ...
                            if (iltemp) {
                                ...
                                extra = ZERO;
                                {
                                    ...
                                    slarot(0, jch > jkl + jku ? 1 : 0, 1, il, c, -s,
                                           &A[aoff], ilda, &extra, &temp);
                                }
                                ic = icol;
                                ir = irow;
                ...
                for (jku = 1; jku <= uub; jku++) {
                    ...
                    for (jc = start_jc; jc >= 1 - jkl; jc--) {
                        ...
                        if (jc > 0) {
                            ...
                            slarot(0, 0, jc + jkl < m ? 1 : 0, il, c, s,
                        ...
                        for (jch = jc + jkl; jch <= iendch; jch += jkl + jku) {
                            ...
                            temp = ZERO;
                            {
                                ...
                                slarot(1, ilextr, iltemp, icol + 2 - ic, c, s,
                                       &A[aoff], ilda, &extra, &temp);
                            }
                            if (iltemp) {
                                ...
                                extra = ZERO;
                                {
                                    ...
                                    slarot(0, 1, jch + jkl + jku <= iendch ? 1 : 0, il, c, s,
                                           &A[aoff], ilda, &temp, &extra);
                                }
                                ic = icol;
                            }
                ...
                for (jkl = 1; jkl <= llb; jkl++) {
                    ...
                    for (jr = start_jr; jr >= 1 - jku; jr--) {
                        ...
                        if (jr > 0) {
                            ...
                            slarot(1, 0, jr + jku < n ? 1 : 0, il, c, s,
                                   &A[aoff], ilda, &dummy, &extra);
                        }
                        ...
                        for (jch = jr + jku; jch <= iendch; jch += jkl + jku) {
                            ...
                            temp = ZERO;
                            {
                                ...
                                slarot(0, ilextr, iltemp, irow + 2 - ir, c, s,
                                       &A[aoff], ilda, &extra, &temp);
                            }
                            if (iltemp) {
                                ...
                                extra = ZERO;
                                {
                                    ...
                                    slarot(1, 1, jch + jkl + jku <= iendch ? 1 : 0, il, c, s,
                                           &A[aoff], ilda, &temp, &extra);
                                }
                                ir = irow;
                            }
