/**
 * @file ssyt01_3.c
 * @brief SSYT01_3 reconstructs a symmetric indefinite matrix A from its
 *        block L*D*L' or U*D*U' factorization (SSYTRF_RK/DSYTRF_BK) and computes the residual.
 *
 * Port of LAPACK TESTING/LIN/ssyt01_3.f to C.
 */
 ...
 * @param[in,out] ipiv    The pivot indices from SSYTRF_RK (or DSYTRF_BK).
