/**
 * @file sbdt01.c
 * @brief SBDT01 reconstructs a general matrix A from its bidiagonal form
 *        and computes the residual.
 *
 * Port of LAPACK's TESTING/EIG/sbdt01.f to C.
 */
    ...
    if (kd != 0) {
        ...
        if (kd != 0 && m >= n) {
            ...
            for (j = 0; j < n; j++) {
                ...
                cblas_sgemv(CblasColMajor, CblasNoTrans, m, n, -ONE,
            ...
            for (j = 0; j < n; j++) {
                ...
                cblas_sgemv(CblasColMajor, CblasNoTrans, m, m, -ONE,
                            Q, ldq, &work[m], 1, ONE, work, 1);
