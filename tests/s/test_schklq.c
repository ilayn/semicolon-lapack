...
extern void slqt01(const int m, const int n, const f32* A, f32* AF,
                   f32* Q, f32* L, const int lda, f32* tau,
                   f32* work, const int lwork, f32* rwork,
                   f32* result);
extern void slqt02(const int m, const int n, const int k,
                   const f32* A, const f32* AF, f32* Q, f32* L,
                   const int lda, const f32* tau,
                   f32* work, const int lwork, f32* rwork,
                   f32* result);
extern void slqt03(const int m, const int n, const int k,
