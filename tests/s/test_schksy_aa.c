...
/* Routines under test */
extern void ssytrf_aa(const char* uplo, const int n, f32* A, const int lda,
                      int* ipiv, f32* work, const int lwork, int* info);
extern void ssytrs_aa(const char* uplo, const int n, const int nrhs,
                      const f32* A, const int lda, const int* ipiv,
                      f32* B, const int ldb, f32* work, const int lwork,
                      int* info);

/* Verification routines */
extern void ssyt01_aa(const char* uplo, const int n, const f32* A,
