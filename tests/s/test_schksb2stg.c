...
extern void ssbtrd(const char* vect, const char* uplo, const int n,
                   const int kd, f32* restrict AB, const int ldab,
                   f32* restrict D, f32* restrict E,
                   f32* restrict Q, const int ldq,
                   f32* restrict work, int* info);
extern void ssytrd_sb2st(const char* stage1, const char* vect,
                         const char* uplo, const int n, const int kd,
                         f32* AB, const int ldab,
                         f32* D, f32* E,
                         f32* hous, const int lhous,
                         f32* work, const int lwork, int* info);
extern void ssteqr(const char* compz, const int n, f32* restrict D,
                   f32* restrict E, f32* restrict Z, const int ldz,
                   f32* restrict work, int* info);
