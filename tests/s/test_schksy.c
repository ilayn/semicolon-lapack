...
extern void ssytri2(const char* uplo, const int n, f32* A, const int lda,
                    const int* ipiv, f32* work, const int lwork, int* info);
...
extern void ssytrs2(const char* uplo, const int n, const int nrhs,
                    f32* A, const int lda, const int* ipiv,
                    f32* B, const int ldb, f32* work, int* info);
...
extern void ssycon(const char* uplo, const int n, const f32* A,
                   const int lda, const int* ipiv, const f32 anorm,
                   f32* rcond, f32* work, int* iwork, int* info);

/* Verification routines */
extern void ssyt01(const char* uplo, const int n, const f32* A,
