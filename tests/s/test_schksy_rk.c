...
extern void ssytrf_rk(const char* uplo, const int n, f32* A, const int lda,
                      f32* E, int* ipiv, f32* work, const int lwork,
                      int* info);
extern void ssytri_3(const char* uplo, const int n, f32* A, const int lda,
                     const f32* E, const int* ipiv, f32* work,
                     const int lwork, int* info);
extern void ssytrs_3(const char* uplo, const int n, const int nrhs,
                     const f32* A, const int lda, const f32* E,
                     const int* ipiv, f32* B, const int ldb, int* info);
extern void ssycon_3(const char* uplo, const int n, const f32* A,
                     const int lda, const f32* E, const int* ipiv,
                     const f32 anorm, f32* rcond, f32* work,
                     int* iwork, int* info);

/* Verification routines */
extern void ssyt01_3(const char* uplo, const int n, const f32* A,
                     const int lda, f32* AFAC, const int ldafac,
                     f32* E, int* ipiv, f32* C, const int ldc,
                     f32* rwork, f32* resid);
