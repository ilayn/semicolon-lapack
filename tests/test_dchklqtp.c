...
extern void dlqt05(const int m, const int n, const int l, const int nb,
...
static void run_dchklqtp_single(int m, int n, int l, int nb)
{
    ...
    // - nb > m: dtplqt requires mb <= m
    // - nb <= 0: invalid block size
    // - m == 0: trivial case
    // - n > 0 && nb > n: dlqt05.f documents "NB <= N" constraint (line 53)
