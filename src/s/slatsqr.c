/**
 * @file slatsqr.c
 * @brief SLATSQR computes a blocked Tall-Skinny QR factorization of
             ...
             INT* info)
{
    ...
    *info = 0;
    ...
    if (ii < m) {
        stpqrt(kk, n, 0, nb, &A[0], lda, &A[ii], lda,
               &T[0 + ctr * n * ldt], ldt, work, info);
    }
