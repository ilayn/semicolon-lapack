 ...
 */
void slarfy(const char* uplo, const int n, const float* const restrict V,
            const int incv, const float tau, float* const restrict C,
            const int ldc, float* const restrict work)
{
    float alpha;
