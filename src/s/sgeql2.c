/**
 * @file sgeql2.c
 * @brief SGEQL2 computes a QL factorization of a general M-by-N matrix
 ...
 */
void sgeql2(const int m, const int n,
            ...
            int *info)
{
    ...
    *info = 0;
    ...
    for (i = k - 1; i >= 0; i--) {
        ...
        slarfg(m - k + i + 1, &A[(m - k + i) + (n - k + i) * lda],
