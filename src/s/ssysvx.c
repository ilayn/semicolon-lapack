/**
 * @file ssysvx.c
 * @brief SSYSVX computes the solution to a real system of linear equations
 ...
 * @param[in,out] AF    If fact = 'F', contains the factored form from SSYTRF.
 ...
 * @param[in,out] ipiv  If fact = 'F', contains the pivot indices from SSYTRF.
    ...
    int* info)
{
    ...
    *info = 0;
    ...
    ssyrfs(uplo, n, nrhs, A, lda, AF, ldaf, ipiv, B, ldb, X, ldx,
