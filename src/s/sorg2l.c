/**
 * @file sorg2l.c
 * @brief SORG2L generates all or part of the orthogonal matrix Q from
 ...
 *                      for i = 0,1,...,k-1, as returned by SGEQLF in the
            ...
            int *info)
{
    ...
    *info = 0;
    ...
    for (i = 0; i < k; i++) {
        ...
        slarf1l("L", m - n + ii + 1, ii, &A[0 + ii * lda], 1, tau[i],
                A, lda, work);
        cblas_sscal(m - n + ii, -tau[i], &A[0 + ii * lda], 1);
