    ...
    *info = 0;
    ...
    if (uplo[0] == 'U' || uplo[0] == 'u') {
        ...
        while (1) {
            ...
            if (k < n - 1) {
                cblas_sgemv(CblasColMajor, CblasNoTrans, k + 1, n - k - 1, -ONE,
            ...
            if (fmaxf(absakk, colmax) == ZERO) {
                ...
                if (!(absakk < alpha * colmax)) {
                    ...
                    while (!done) {
                        ...
                        if (imax != k) {
                            jmax = imax + 1 + cblas_isamax(k - imax, &W[imax + 1 + (kw - 1) * ldw], 1);
        ...
        *kb = n - k - 1;
        ...
        while (1) {
            ...
            if (k > 0) {
                cblas_sgemv(CblasColMajor, CblasNoTrans, n - k, k, -ONE,
