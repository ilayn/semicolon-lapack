/**
 * @file sla_geamv.c
 * @brief SLA_GEAMV computes a matrix-vector product using a general matrix
...
void sla_geamv(const INT trans, const INT m, const INT n,
               const f32 alpha, const f32* restrict A,
               const INT lda, const f32* restrict X,
