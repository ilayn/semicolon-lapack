/**
 * @file ssbevx_2stage.c
 * @brief SSBEVX_2STAGE computes selected eigenvalues and optionally eigenvectors
    ...
    INT* info)
{
    ...
    f32 sigma = 0.0f, smlnum, tmp1, vll, vuu;
    ...
    *m = 0;
    ...
    ssytrd_sb2st("N", jobz, uplo, n, kd, AB, ldab,
    ...
    indiwo = indisp + n;
    {
        ...
        sstebz(range_str, order_str, n, vll, vuu, il, iu, abstll,
