/**
 * @file sstegr.c
 * @brief SSTEGR computes selected eigenvalues and, optionally, eigenvectors
    ...
    int* info)
{
    ...
    // SSTEGR is simply a wrapper around SSTEMR
    // Note: abstol is unused in sstemr, tryrac is set to false
    (void)abstol;  // Unused parameter

    *info = 0;

    sstemr(jobz, range, n, D, E, vl, vu, il, iu, m, W, Z, ldz, n, isuppz,
