/**
 * @file sopmtr.c
 * @brief SOPMTR overwrites the general real M-by-N matrix C with
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        for (i = i1; i3 > 0 ? i <= i2 : i >= i2; i += i3) {
            ...
            slarf1l(side, mi, ni, &AP[ii - i], 1, tau[i], C, ldc, work);
        ...
        for (i = i1; i3 > 0 ? i <= i2 : i >= i2; i += i3) {
            ...
            slarf(side, mi, ni, &AP[ii], 1, tau[i], &C[ic + jc * ldc], ldc, work);
            AP[ii] = aii;
