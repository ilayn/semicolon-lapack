/**
 * @file spotrf2.c
 * @brief SPOTRF2 computes the Cholesky factorization of a symmetric positive
    ...
    *info = 0;
    ...
    if (n == 1) {
        ...
        if (upper) {
            ...
            // Factor A22
            spotrf2(uplo, n2, &A[n1 + n1 * lda], lda, &iinfo);
            if (iinfo != 0) {
                *info = iinfo + n1;
                return;
            }
