    ...
    if (upper) {
        ...
        if (update) {
            ...
            if (wantx) {
                ...
                cblas_sscal(n - m, ONE / bii, &X[m + (i - 1) * ldx], 1);
                if (kbt > 0)
                    cblas_sger(CblasColMajor, n - m, kbt, -ONE, &X[m + (i - 1) * ldx], 1,
        ...
        for (k = 1; k <= kb - 1; k++) {
            ...
            if (nrt > 0)
                slargv(nrt, &AB[0 + (j2t - 1) * ldab], inca, &work[j2t - m - 1], ka1,
                       &work[n + j2t - m - 1], ka1);
            if (nr > 0) {
                // apply rotations in 1st set from the right
                for (l = 1; l <= ka - 1; l++) {
                    slartv(nr, &AB[ka1 - l - 1 + (j2 - 1) * ldab], inca,
                           &AB[ka - l - 1 + (j2) * ldab], inca,
                           &work[n + j2 - m - 1], &work[j2 - m - 1], ka1);
                }

                // apply rotations in 1st set from both sides to diagonal blocks
                slar2v(nr, &AB[ka + (j2 - 1) * ldab], &AB[ka + (j2) * ldab],
            ...
            for (l = ka - 1; l >= kb - k + 1; l--) {
                nrt = (n - j2 + l) / ka1;
                if (nrt > 0)
                    slartv(nrt, &AB[l - 1 + (j2 + ka1 - l - 1) * ldab], inca,
            ...
            if (wantx) {
                ...
                for (j = j2; j <= j1; j += ka1) {
                    cblas_srot(n - m, &X[m + (j - 1) * ldx], 1, &X[m + (j) * ldx], 1,
        ...
        for (k = kb; k >= 1; k--) {
            ...
            for (l = kb - k; l >= 1; l--) {
                nrt = (n - j2 + ka + l) / ka1;
                if (nrt > 0)
                    slartv(nrt, &AB[l - 1 + (j2 - l) * ldab], inca,
                           &AB[l + (j2 - l) * ldab], inca,
        ...
        for (k = kb; k >= 1; k--) {
            ...
            if (nr > 0) {
                ...
                slargv(nr, &AB[0 + (j2 - 1) * ldab], inca, &work[j2 - 1], ka1, &work[n + j2 - 1], ka1);
        ...
        for (k = 1; k <= kb - 1; k++) {
            if (update) {
                ...
                if (i - k + ka < n && i - k > 1) {
                    ...
                    slartg(AB[ka1 - k - 1 + (i - 1) * ldab], ra1,
                           &work[n + i - k + ka - m - 1], &work[i - k + ka - m - 1], &ra);
            ...
            // generate rotations in 1st set to annihilate elements outside the band
            if (nrt > 0)
                slargv(nrt, &AB[ka + (j2t - ka - 1) * ldab], inca, &work[j2t - m - 1], ka1,
                       &work[n + j2t - m - 1], ka1);
            if (nr > 0) {
                // apply rotations in 1st set from the left
                for (l = 1; l <= ka - 1; l++) {
                    slartv(nr, &AB[l + (j2 - l - 1) * ldab], inca,
                           &AB[l + 1 + (j2 - l - 1) * ldab], inca,
                           &work[n + j2 - m - 1], &work[j2 - m - 1], ka1);
                }

                // apply rotations in 1st set from both sides to diagonal blocks
                slar2v(nr, &AB[0 + (j2 - 1) * ldab], &AB[0 + (j2) * ldab],
                       &AB[1 + (j2 - 1) * ldab], inca,
                       &work[n + j2 - m - 1], &work[j2 - m - 1], ka1);
            }
            ...
            for (l = ka - 1; l >= kb - k + 1; l--) {
                nrt = (n - j2 + l) / ka1;
                if (nrt > 0)
                    slartv(nrt, &AB[ka1 - l + (j2 - 1) * ldab], inca,
        ...
        for (k = kb; k >= 1; k--) {
            ...
            for (l = kb - k; l >= 1; l--) {
                nrt = (n - j2 + ka + l) / ka1;
                if (nrt > 0)
                    slartv(nrt, &AB[ka1 - l + (j2 - ka - 1) * ldab], inca,
        ...
        for (k = kb; k >= 1; k--) {
            ...
            if (nr > 0) {
                // generate rotations in 2nd set to annihilate elements outside the band
                slargv(nr, &AB[ka + (j2 - ka - 1) * ldab], inca, &work[j2 - 1], ka1, &work[n + j2 - 1], ka1);
...
L490:
    ...
    if (upper) {
        ...
        if (update) {
            ...
            if (wantx) {
                // post-multiply X by inv(S(i))
                cblas_sscal(nx, ONE / bii, &X[0 + (i - 1) * ldx], 1);
                if (kbt > 0)
                    cblas_sger(CblasColMajor, nx, kbt, -ONE, &X[0 + (i - 1) * ldx], 1,
        ...
        for (k = 1; k <= kb - 1; k++) {
            ...
            // generate rotations in 1st set to annihilate elements outside the band
            if (nrt > 0)
                slargv(nrt, &AB[0 + (j1 + ka - 1) * ldab], inca, &work[j1 - 1], ka1,
                       &work[n + j1 - 1], ka1);
            if (nr > 0) {
                // apply rotations in 1st set from the left
                for (l = 1; l <= ka - 1; l++) {
                    slartv(nr, &AB[ka1 - l - 1 + (j1 + l - 1) * ldab], inca,
                           &AB[ka - l - 1 + (j1 + l - 1) * ldab], inca,
                           &work[n + j1 - 1], &work[j1 - 1], ka1);
                }

                // apply rotations in 1st set from both sides to diagonal blocks
                slar2v(nr, &AB[ka + (j1 - 1) * ldab], &AB[ka + (j1 - 1 - 1) * ldab],
            ...
            for (l = ka - 1; l >= kb - k + 1; l--) {
                ...
                j1t = j2 - (nrt - 1) * ka1;
                if (nrt > 0)
                    slartv(nrt, &AB[l - 1 + (j1t - 1) * ldab], inca,
            ...
            if (wantx) {
                // post-multiply X by product of rotations in 1st set
                for (j = j1; j <= j2; j += ka1) {
                    cblas_srot(nx, &X[0 + (j - 1) * ldx], 1, &X[0 + (j - 1 - 1) * ldx], 1,
                               work[n + j - 1], work[j - 1]);
                }
            }
        }
        ...
        for (k = kb; k >= 1; k--) {
            ...
            for (l = kb - k; l >= 1; l--) {
                ...
                j1t = j2 - (nrt - 1) * ka1;
                if (nrt > 0)
                    slartv(nrt, &AB[l - 1 + (j1t + ka - 1) * ldab], inca,
        ...
        for (k = kb; k >= 1; k--) {
            ...
            if (nr > 0) {
                // generate rotations in 2nd set to annihilate elements outside the band
                slargv(nr, &AB[0 + (j1 + ka - 1) * ldab], inca, &work[m - kb + j1 - 1], ka1,
        ...
        for (k = 1; k <= kb - 1; k++) {
            if (update) {
                ...
                if (i + k - ka1 > 0 && i + k < m) {
                    // generate rotation to annihilate a(i,i+k-ka-1)
                    slartg(AB[ka1 - k - 1 + (i + k - ka - 1) * ldab], ra1,
                           &work[n + i + k - ka - 1], &work[i + k - ka - 1], &ra);
            ...
            // generate rotations in 1st set to annihilate elements outside the band
            if (nrt > 0)
                slargv(nrt, &AB[ka + (j1 - 1) * ldab], inca, &work[j1 - 1], ka1,
                       &work[n + j1 - 1], ka1);
            if (nr > 0) {
                // apply rotations in 1st set from the right
                for (l = 1; l <= ka - 1; l++) {
                    slartv(nr, &AB[l + (j1 - 1) * ldab], inca,
                           &AB[l + 1 + (j1 - 1 - 1) * ldab], inca,
                           &work[n + j1 - 1], &work[j1 - 1], ka1);
                }

                // apply rotations in 1st set from both sides to diagonal blocks
                slar2v(nr, &AB[0 + (j1 - 1) * ldab], &AB[0 + (j1 - 1 - 1) * ldab],
            ...
            for (l = ka - 1; l >= kb - k + 1; l--) {
                ...
                j1t = j2 - (nrt - 1) * ka1;
                if (nrt > 0)
                    slartv(nrt, &AB[ka1 - l + (j1t - ka1 + l - 1) * ldab], inca,
        ...
        for (k = kb; k >= 1; k--) {
            ...
            for (l = kb - k; l >= 1; l--) {
                ...
                j1t = j2 - (nrt - 1) * ka1;
                if (nrt > 0)
                    slartv(nrt, &AB[ka1 - l + (j1t + l - 1 - 1) * ldab], inca,
        ...
        for (k = kb; k >= 1; k--) {
            ...
            if (nr > 0) {
                // generate rotations in 2nd set to annihilate elements outside the band
                slargv(nr, &AB[ka + (j1 - 1) * ldab], inca, &work[m - kb + j1 - 1], ka1,
                       &work[n + m - kb + j1 - 1], ka1);
