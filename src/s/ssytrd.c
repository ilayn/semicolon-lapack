/**
 * @file ssytrd.c
 * @brief SSYTRD reduces a real symmetric matrix to real symmetric
    ...
    if (upper) {
        ...
        for (i = n - nb; i >= kk; i -= nb) {
            ...
            /* slatrd(uplo, n, nb, A, lda, E, tau, W, ldw)
               Fortran: SLATRD(UPLO, I+NB-1, NB, A, LDA, E, TAU, WORK, LDWORK)
            ...
            slatrd(uplo, i + nb, nb, A, lda, E, tau, work, ldwork);
        ...
        /* Fortran: SSYTD2(UPLO, KK, A, LDA, D, E, TAU, IINFO)
        ...
        for (i = 0; i < n - nx; i += nb) {
            ...
            /* Fortran: SLATRD(UPLO, N-I+1, NB, A(I,I), LDA, E(I), TAU(I), WORK, LDWORK)
            ...
            slatrd(uplo, n - i, nb, &A[i + i * lda], lda, &E[i],
                   &tau[i], work, ldwork);
        ...
        /* Use unblocked code to reduce the last or only block */
        /* Fortran: SSYTD2(UPLO, N-I+1, A(I,I), LDA, D(I), E(I), TAU(I), IINFO)
        ...
        ssytd2(uplo, n - i, &A[i + i * lda], lda, &D[i], &E[i],
               &tau[i], &iinfo);
    }
