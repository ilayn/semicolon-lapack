    ...
    if (nb <= 1 || nb > kd) {
        ...
        if (upper) {
            ...
            for (i = 0; i < n; i += nb) {
                ...
                spotf2(uplo, ib, &AB[kd + i * ldab], ldab - 1, &ii);
                if (ii != 0) {
                    *info = i + ii;
                    return;
                }
                if (i + ib < n) {
                    ...
                    if (i2 > 0) {
                        ...
                        // Update A22
                        cblas_ssyrk(CblasColMajor, CblasUpper, CblasTrans, i2, ib, -ONE,
                    ...
                    if (i3 > 0) {
                        ...
                        // Update A23
                        if (i2 > 0) {
                            cblas_sgemm(CblasColMajor, CblasTrans, CblasNoTrans, i2, i3,
                                        ib, -ONE, &AB[kd - ib + (i + ib) * ldab],
                                        ldab - 1, work, LDWORK, ONE,
                                        &AB[ib + (i + kd) * ldab], ldab - 1);
                        }
                        // Update A33
                        cblas_ssyrk(CblasColMajor, CblasUpper, CblasTrans, i3, ib, -ONE,
            ...
            for (i = 0; i < n; i += nb) {
                ...
                // Factorize the diagonal block
                spotf2(uplo, ib, &AB[0 + i * ldab], ldab - 1, &ii);
                if (ii != 0) {
                    *info = i + ii;
                    return;
                }
                if (i + ib < n) {
                    ...
                    if (i2 > 0) {
                        ...
                        // Update A22
                        cblas_ssyrk(CblasColMajor, CblasLower, CblasNoTrans, i2, ib, -ONE,
                    ...
                    if (i3 > 0) {
                        ...
                        // Update A32
                        if (i2 > 0) {
                            cblas_sgemm(CblasColMajor, CblasNoTrans, CblasTrans, i3, i2,
                                        ib, -ONE, work, LDWORK,
                                        &AB[ib + i * ldab], ldab - 1, ONE,
                                        &AB[kd - ib + (i + ib) * ldab], ldab - 1);
                        }
                        // Update A33
                        cblas_ssyrk(CblasColMajor, CblasLower, CblasNoTrans, i3, ib, -ONE,
