/**
 * @file sggesx.c
 * @brief SGGESX computes the eigenvalues, the Schur form, and, optionally,
            ...
            INT* restrict bwork, INT* info)
{
    ...
    *sdim = 0;
    ...
    iwrk = itau;
    shgeqz("S", jobvsl, jobvsr, n, ilo, ihi, A, lda, B, ldb,
    ...
    if (wantst) {
        ...
        stgsen(ijob, ilvsl, ilvsr, bwork, n, A, lda, B, ldb,
               alphar, alphai, beta, VSL, ldvsl, VSR, ldvsr,
