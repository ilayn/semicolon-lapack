/**
 * @file slaswlq.c
 * @brief SLASWLQ computes a blocked Short-Wide LQ factorization of a
...
/**
 * SLASWLQ computes a blocked Short-Wide LQ factorization of
             ...
             INT* info)
{
    ...
    *info = 0;
    ...
    if (ii < n) {
        stplqt(m, kk, 0, mb, &A[0 + 0 * lda], lda, &A[0 + ii * lda],
               lda, &T[0 + ctr * m * ldt], ldt, work, info);
    }
