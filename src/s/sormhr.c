/**
 * @file sormhr.c
 * @brief SORMHR overwrites matrix C with Q*C or C*Q or their transposes,
 *        where Q is from the Hessenberg reduction produced by SGEHRD.
 */
 ...
 * @param[in] ilo     Index ilo from SGEHRD (0-based).
 * @param[in] ihi     Index ihi from SGEHRD (0-based).
 * @param[in] A       Array containing the elementary reflectors from SGEHRD.
 * @param[in] lda     Leading dimension of A.
 * @param[in] tau     Array of scalar factors from SGEHRD.
