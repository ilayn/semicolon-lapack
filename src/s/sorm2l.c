/**
 * @file sorm2l.c
 * @brief SORM2L multiplies a general matrix by the orthogonal matrix from
 ...
 */
void sorm2l(const char* side, const char* trans,
            ...
            int *info)
{
    ...
    *info = 0;
    ...
    for (i = i1; i3 > 0 ? i <= i2 : i >= i2; i += i3) {
         ...
         * with v(last) = 1, so we use slarf1l */
        slarf1l(side, mi, ni, &A[0 + i * lda], 1, tau[i],
                C, ldc, work);
    }
}
