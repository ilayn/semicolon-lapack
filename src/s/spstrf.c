/**
 * @file spstrf.c
 * @brief SPSTRF computes the Cholesky factorization with complete pivoting
        ...
        for (int k = 0; k < n && jstop < 0; k += nb) {
            ...
            for (int j = k; j < k + jb && jstop < 0; j++) {
                ...
                if (j < n - 1) {
                    ...
                    if (j > k) {
                        cblas_sgemv(CblasColMajor, CblasTrans, j - k, n - j - 1,
        ...
        for (int k = 0; k < n && jstop < 0; k += nb) {
            ...
            for (int j = k; j < k + jb && jstop < 0; j++) {
                ...
                if (j < n - 1) {
                    ...
                    if (j > k) {
                        cblas_sgemv(CblasColMajor, CblasNoTrans, n - j - 1, j - k,
