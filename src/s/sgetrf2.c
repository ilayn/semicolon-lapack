 ...
 * (n <= RECURSION_THRESHOLD), it falls back to the unblocked sgetf2.
 *
    ...
    int* info)
{
    ...
    *info = 0;
    ...
    //                       [ A22 ]
    slaswp(n2, A + n1 * lda, lda, 0, n1 - 1, ipiv, 1);
    ...
    // Factor A22
    sgetrf2(m - n1, n2, A + n1 * lda + n1, lda, &ipiv[n1], &iinfo);
    ...
    slaswp(n1, A, lda, n1, minmn - 1, ipiv, 1);
}
