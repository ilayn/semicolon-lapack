/**
 * @file sgemqrt.c
 * @brief SGEMQRT overwrites the general real M-by-N matrix C with the product
 *        of Q (or Q^T) and C, using the compact WY representation from SGEQRT.
 */
 ...
 *                       as returned by SGEQRT in the first k columns of its
 *                       array argument A.
 ...
 *                       as returned by SGEQRT, stored as an nb-by-k matrix.
