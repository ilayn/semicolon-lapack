/**
 * @file slaqr2.c
 * @brief SLAQR2 performs aggressive early deflation.
 */
...
/**
 * SLAQR2 performs the orthogonal similarity transformation of a Hessenberg
 * matrix to detect and deflate fully converged eigenvalues from a trailing
 * principal submatrix (aggressive early deflation).
 *
 * SLAQR2 is identical to SLAQR3 except that it avoids recursion by calling
 * SLAHQR instead of SLAQR4.
 *
