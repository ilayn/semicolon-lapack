        ...
        if (n == 0) {
            ...
            if (wantvl) {
                ...
                if (wntsnn) {
                    ...
                    shseqr("S", "N", n, 0, n - 1, A, lda, wr, wi, VR, ldvr,
                           work, -1, info);
                }
            }
            hswork = (int)work[0];
    ...
    *abnrm = slange("1", n, n, A, lda, dum);
    ...
    if (wantvl) {
        ...
        iwrk = itau;
        {
            ...
            shseqr(job_str, "N", n, *ilo, *ihi, A, lda, wr, wi, VR, ldvr,
                   &work[iwrk], lwork - iwrk, info);
        }
    }
    ...
    if (!wntsnn) {
        strsna(sense, "A", select, n, A, lda, VL, ldvl, VR, ldvr,
