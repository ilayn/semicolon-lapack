/**
 * @file slaed7.c
 * @brief SLAED7 computes the updated eigensystem of a diagonal matrix after
            ...
            int* info)
{
    ...
    *info = 0;
     ...
     */
    rho_local = rho;
    slaed8(icompq, &k, n, qsiz, D, Q, ldq, indxq, &rho_local,
     ...
     */
    if (k != 0) {
        slaed9(k, 0, k, n, D, &work[is], k, rho_local,
               &work[idlmda], &work[iw],
        ...
        if (icompq == 1) {
            cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                        qsiz, k, k, 1.0f, &work[iq2], ldq2,
                        &qstore[qptr[curr]], k, 0.0f, Q, ldq);
        }
