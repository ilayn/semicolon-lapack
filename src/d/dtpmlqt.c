/**
 * @file dtpmlqt.c
 * @brief DTPMLQT applies a real orthogonal matrix Q obtained from a
 ...
 *                        the elementary reflector H(i), as returned by DTPLQT
 *                        in B.
 ...
 */
void dtpmlqt(const char* side, const char* trans, const INT m, const INT n,
