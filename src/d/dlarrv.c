/**
 * @file dlarrv.c
 * @brief DLARRV computes the eigenvectors of the tridiagonal matrix
            ...
            f64* work, INT* iwork, INT* info)
{
    ...
    *info = 0;
    ...
    dlaset("Full", n, zusedw, ZERO, ZERO, &Z[zusedl * ldz], ldz);
        ...
        while (idone < im) {
            ...
            for (i = 0; i < oldncl; i++) {
                ...
                if (ndepth > 0) {
                    ...
                    cblas_dcopy(in, &Z[ibegin + j * ldz], 1, &D[ibegin], 1);
                    cblas_dcopy(in - 1, &Z[ibegin + (j + 1) * ldz], 1, &L[ibegin], 1);
                    sigma = Z[iend + (j + 1) * ldz];

                    /* Set the corresponding entries in Z to zero */
                    dlaset("Full", in, 2, ZERO, ZERO, &Z[ibegin + j * ldz], ldz);
                }
...
label_120:
                        ...
                        dlar1v(in, 0, in - 1, lambda, &D[ibegin],
                        ...
                        cblas_dscal(zto - zfrom + 1, nrminv,
