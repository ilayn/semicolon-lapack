/**
 * @file dsteqr.c
 * @brief DSTEQR computes all eigenvalues and, optionally, eigenvectors of a
    ...
    if (icompz == 0) {
        ...
        for (INT ii = 1; ii < n; ii++) {
            ...
            if (k != i) {
                D[k] = D[i];
                D[i] = p;
                cblas_dswap(n, &Z[0 + i * ldz], 1, &Z[0 + k * ldz], 1);
            }
        }
    }
}
