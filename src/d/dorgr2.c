/**
 * @file dorgr2.c
 * @brief DORGR2 generates all or part of the orthogonal matrix Q from
 ...
 *                      i = 0,1,...,k-1, as returned by DGERQF in the last
            ...
            int *info)
{
    ...
    *info = 0;
    ...
    for (i = 0; i < k; i++) {
        ...
        dlarf1l("R", ii, n - m + ii + 1, &A[ii + 0 * lda], lda,
                tau[i], A, lda, work);
        cblas_dscal(n - m + ii, -tau[i], &A[ii + 0 * lda], lda);
