/**
 * @file dgebak.c
 * @brief DGEBAK forms the right or left eigenvectors of a real general matrix
 ...
 * @param[in]     ilo    The integers ILO and IHI determined by DGEBAL.
 ...
 *                       by DGEBAL. Permutation indices are 0-based.
