/**
 * @file dlauu2.c
 * @brief DLAUU2 computes the product U * U**T or L**T * L (unblocked algorithm).
 */
    ...
    if (upper) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (i < n - 1) {
                ...
                A[i + i * lda] = cblas_ddot(n - i, &A[i + i * lda], lda,
                                            &A[i + i * lda], lda);
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (i < n - 1) {
                ...
                A[i + i * lda] = cblas_ddot(n - i, &A[i + i * lda], 1,
                                            &A[i + i * lda], 1);
