/**
 * @file dorgqr.c
 * @brief DORGQR generates all or part of the orthogonal matrix Q from
 *        a QR factorization determined by DGEQRF (blocked algorithm).
 */
 ...
 *                       i = 0,1,...,k-1, as returned by DGEQRF.
    ...
    *info = 0;
    ...
    if (kk > 0) {
        ...
        for (i = ki; i >= 0; i -= nb) {
            ...
            dorg2r(m - i, ib, ib, &A[i + i * lda], lda,
                   &tau[i], work, &iinfo);
