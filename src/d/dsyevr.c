/**
 * @file dsyevr.c
 * @brief DSYEVR computes selected eigenvalues and, optionally, eigenvectors of a
            ...
            int* info)
{
    ...
    *m = 0;
     ...
     * to zero, then call DSTERF or DSTEMR and DORMTR. */
    if ((alleig || (indeig && il == 0 && iu == n - 1)) && ieeeok == 1) {
        ...
        if (*info == 0) {
            /* Everything worked. Skip DSTEBZ/DSTEIN. */
            *m = n;
            goto L30;
        }
        *info = 0;
