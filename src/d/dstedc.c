/**
 * @file dstedc.c
 * @brief DSTEDC computes all eigenvalues and, optionally, eigenvectors of a
        ...
        L20:
            ...
            if (m > SMLSIZ) {
                ...
                if (icompz == 1) {
                     ...
                     */
                    dsteqr("I", m, &D[start], &E[start], work,
                            m, &work[m * m], info);
                    dlacpy("A", n, m, &Z[start * ldz], ldz,
                            &work[storez], n);
