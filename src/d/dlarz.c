/**
 * @file dlarz.c
 * @brief DLARZ applies an elementary reflector (as returned by DTZRZF) to a
 *        general matrix.
 */
           ...
           double * restrict work)
{
    if (side[0] == 'L' || side[0] == 'l') {
        ...
        if (tau != 0.0) {
            ...
            cblas_dgemv(CblasColMajor, CblasNoTrans, m, l, 1.0,
                        &C[0 + (n - l) * ldc], ldc,
                        v, incv, 1.0, work, 1);
