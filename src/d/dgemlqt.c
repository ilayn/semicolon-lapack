/**
 * @file dgemlqt.c
 * @brief DGEMLQT overwrites the general real M-by-N matrix C with the product
 *        of Q (or Q^T) and C, using the compact WY representation from DGELQT.
 */
