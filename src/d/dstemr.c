/**
 * @file dstemr.c
 * @brief DSTEMR computes selected eigenvalues and, optionally, eigenvectors
 ...
 * @param[out]    Z       Double precision array, dimension (ldz, nzc). Eigenvectors.
...
void dstemr(const char* jobz, const char* range, const int n,
            ...
            double* Z, const int ldz, const int nzc, int* isuppz,
