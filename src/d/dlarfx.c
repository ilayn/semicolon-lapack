/**
 * @file dlarfx.c
 * @brief DLARFX applies an elementary reflector to a general rectangular
...
void dlarfx(const char* side, const int m, const int n,
            const double * const restrict v, const double tau,
            double * const restrict C, const int ldc,
            double * restrict work)
{
    int j;
    double sum, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10;
    ...
    if (side[0] == 'L' || side[0] == 'l') {
        ...
        default:
            /* Code for general m */
            dlarf("L", m, n, v, 1, tau, C, ldc, work);
            break;
        }
        ...
        default:
            /* Code for general n */
            dlarf("R", m, n, v, 1, tau, C, ldc, work);
            break;
        }
    }
}
