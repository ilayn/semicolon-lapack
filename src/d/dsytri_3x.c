/**
 * @file dsytri_3x.c
 * @brief DSYTRI_3X computes the inverse of a real symmetric indefinite matrix using the factorization computed by DSYTRF_RK or DSYTRF_BK (blocked algorithm).
 */
