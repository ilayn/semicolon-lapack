/**
 * @file dtpmqrt.c
 * @brief DTPMQRT applies a real orthogonal matrix Q obtained from a
 ...
 *                        the elementary reflector H(i), as returned by DTPQRT
 *                        in B.
 ...
 *                        as returned by DTPQRT, stored as a nb-by-k matrix.
