/**
 * @file dgbbrd.c
 * @brief DGBBRD reduces a real general band matrix to bidiagonal form.
 */
            ...
            f64* const restrict work, int* info)
{
    ...
    *info = 0;
    ...
    if (wantq) {
        dlaset("Full", m, m, zero, one, Q, ldq);
    }
    if (wantpt) {
        dlaset("Full", n, n, zero, one, PT, ldpt);
    }
        ...
        for (int i = 0; i < minmn; i++) {
            ...
            for (int kk = 0; kk < kb; kk++) {
                ...
                if (nr > 0) {
                    ...
                    dlargv(nr, &AB[(klu1 - 1) + (j1 - klm - 1) * ldab], inca,
                ...
                for (int l = 0; l < kb; l++) {
                    ...
                    if (nrt > 0) {
                        ...
                        dlartv(nrt, &AB[(klu1 - l - 2) + (j1 - klm + l) * ldab], inca,
                ...
                if (nr > 0) {
                    ...
                    dlargv(nr, &AB[(j1 + kun - 1) * ldab], inca,
                ...
                for (int l = 0; l < kb; l++) {
                    ...
                    if (nrt > 0) {
                        ...
                        dlartv(nrt, &AB[(l + 1) + (j1 + kun - 1) * ldab], inca,
                ...
                if (wantpt) {
                    ...
                    for (int j = j1; j <= j2; j += kb1) {
                        ...
                        cblas_drot(n, &PT[(j + kun - 1) * ldpt], 1,
                                   &PT[(j + kun) * ldpt], 1,
    ...
    if (ku == 0 && kl > 0) {
        ...
        for (int i = 0; i < MIN(m - 1, n); i++) {
            ...
            if (wantq) {
                cblas_drot(m, &Q[i * ldq], 1, &Q[(i + 1) * ldq], 1, rc, rs);
            }
            if (wantc) {
                cblas_drot(ncc, &C[i], ldc, &C[i + 1], ldc, rc, rs);
            }
        }
        if (m <= n) {
            D[m - 1] = AB[(m - 1) * ldab];
        ...
        if (m < n) {
            ...
            for (int i = m - 1; i >= 0; i--) {
                ...
                if (wantpt) {
                    cblas_drot(n, &PT[i * ldpt], 1, &PT[m * ldpt], 1, rc, rs);
                }
            }
        } else {
            /*
