    ...
    *info = 0;
    ...
    if (uplo[0] == 'U' || uplo[0] == 'u') {
        ...
        while (1) {
            ...
            if (k < n - 1) {
                cblas_dgemv(CblasColMajor, CblasNoTrans, k + 1, n - k - 1, -ONE,
         ...
         *
         * We use cblas_dgemm since DGEMMTR is not standard CBLAS. */
        ...
        *kb = n - k - 1;
        ...
        while (1) {
            ...
            if (k > 0) {
                cblas_dgemv(CblasColMajor, CblasNoTrans, n - k, k, -ONE,
