/**
 * @file dsbgv.c
 * @brief DSBGV computes all eigenvalues of a generalized symmetric-definite banded eigenproblem.
 */
    ...
    int* info)
{
    ...
    *info = 0;
    ...
    // For eigenvalues only, call dsterf. For eigenvectors, call dsteqr.
    if (!wantz) {
