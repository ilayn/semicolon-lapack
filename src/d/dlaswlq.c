/**
 * @file dlaswlq.c
 * @brief DLASWLQ computes a blocked Short-Wide LQ factorization of a
 *        real M-by-N matrix A for M <= N.
 */

#include "semicolon_lapack_double.h"

/**
 * DLASWLQ computes a blocked Short-Wide LQ factorization of
 ...
 * @param[out]    T      Double precision array, dimension
             ...
             int* info)
{
    ...
    *info = 0;
    ...
    if (ii < n) {
        dtplqt(m, kk, 0, mb, &A[0 + 0 * lda], lda, &A[0 + ii * lda],
               lda, &T[0 + ctr * m * ldt], ldt, work, info);
    }
