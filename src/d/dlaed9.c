/**
 * @file dlaed9.c
 * @brief DLAED9 finds the roots of the secular equation and updates the
            ...
            int* info)
{
    ...
    *info = 0;
    ...
    /* For each eigenvalue in [kstart, kstop), call dlaed4 to find the root. */
