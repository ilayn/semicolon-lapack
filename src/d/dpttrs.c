/**
 * @file dpttrs.c
 * @brief DPTTRS solves a tridiagonal system of the form A*X = B using the
 *        L*D*L**T factorization of A computed by DPTTRF.
 */
    ...
    int* info)
{
    ...
    *info = 0;
    ...
    /*
     * ILAENV(1, 'DPTTRS', ...) returns NB=1 (no special case in ilaenv.f).
     * Therefore, we call dptts2 directly without blocking.
     */
