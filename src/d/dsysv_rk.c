/**
 * @file dsysv_rk.c
 * @brief DSYSV_RK computes the solution to system of linear equations A * X = B for SY matrices using DSYTRF_RK/DSYTRS_3.
 */
 ...
 *                      factorization routine `dsytrf_rk`, i.e. the
 ...
 *                      of D, as determined by `dsytrf_rk`.
 *
 *                      For more info see the description of `dsytrf_rk`.
