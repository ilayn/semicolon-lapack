/**
 * @file dsytrs_aa.c
 * @brief DSYTRS_AA solves a system of linear equations A*X = B with a real symmetric matrix using the factorization computed by DSYTRF_AA.
 */
    ...
    int* info)
{
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        dgtsv(n, nrhs, &work[0], &work[n - 1], &work[2 * n - 1], B, ldb, info);
