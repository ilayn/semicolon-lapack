    ...
    *info = 0;
    ...
    if (m >= n) {
        ...
        for (i = 0; i < n; i++) {
            ...
            if (i < n - 1) {
                dlarf1f("L", m - i, n - i - 1, &A[i + i * lda], 1, tauq[i],
            ...
            if (i < n - 1) {
                ...
                dlarf1f("R", m - i - 1, n - i - 1, &A[i + (i + 1) * lda], lda,
        ...
        for (i = 0; i < m; i++) {
            ...
            if (i < m - 1) {
                dlarf1f("R", m - i - 1, n - i, &A[i + i * lda], lda, taup[i],
            ...
            if (i < m - 1) {
                ...
                dlarf1f("L", m - i - 1, n - i - 1, &A[i + 1 + i * lda], 1,
