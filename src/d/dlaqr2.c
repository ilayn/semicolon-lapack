...
/**
 * DLAQR2 performs the orthogonal similarity transformation of a Hessenberg
 * matrix to detect and deflate fully converged eigenvalues from a trailing
 * principal submatrix (aggressive early deflation).
 *
 * DLAQR2 is identical to DLAQR3 except that it avoids recursion by calling
 * DLAHQR instead of DLAQR4.
 *
