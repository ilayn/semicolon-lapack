/**
 * @file dgemqr.c
 * @brief DGEMQR overwrites matrix C with Q*C, Q^T*C, C*Q, or C*Q^T
 *        where Q is defined by a QR factorization from DGEQR.
 */
            ...
            INT* info)
{
    ...
    /* Read block sizes from T array (stored by DGEQR) */
    mb = (INT)T[1];
    nb = (INT)T[2];
