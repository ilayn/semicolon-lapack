/**
 * @file dsyrfs.c
 * @brief DSYRFS improves the computed solution to a system of linear
 ...
 *                      as determined by DSYTRF. Integer array, dimension (n).
 * @param[in]     B     The right hand side matrix B.
 *                      Double precision array, dimension (ldb, nrhs).
 * @param[in]     ldb   The leading dimension of the array B. ldb >= max(1, n).
 * @param[in,out] X     On entry, the solution matrix X, as computed by DSYTRS.
    ...
    *info = 0;
    ...
    for (j = 0; j < nrhs; j++) {
        ...
        while (1) {
            ...
            cblas_dsymv(CblasColMajor, upper ? CblasUpper : CblasLower,
            ...
            dsytrs(uplo, n, 1, AF, ldaf, ipiv, &work[n], n, &linfo);
