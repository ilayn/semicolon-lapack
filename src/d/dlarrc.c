/**
 * @file dlarrc.c
 * @brief DLARRC computes the number of eigenvalues of the symmetric tridiagonal matrix.
 */
...
/**
 * DLARRC finds the number of eigenvalues of the symmetric tridiagonal
