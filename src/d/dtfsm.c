            ...
            if (normaltransr) {
                ...
                if (lower) {
                    ...
                    if (notrans) {
                        ...
                        if (m == 1) {
                            cblas_dtrsm(CblasColMajor, CblasLeft, CblasLower, CblasNoTrans, cblas_diag,
                            ...
                            cblas_dtrsm(CblasColMajor, CblasLeft, CblasUpper, CblasTrans, cblas_diag,
                        ...
                        if (m == 1) {
                            cblas_dtrsm(CblasColMajor, CblasLeft, CblasLower, CblasTrans, cblas_diag,
                                        m1, n, alpha, &A[0], m, B, ldb);
                        } else {
                            cblas_dtrsm(CblasColMajor, CblasLeft, CblasUpper, CblasNoTrans, cblas_diag,
            ...
            if (normaltransr) {
                ...
                if (lower) {
                    ...
                    if (notrans) {
                        ...
                        cblas_dtrsm(CblasColMajor, CblasRight, CblasUpper, CblasTrans, cblas_diag,
                                    m, n2, alpha, &A[n], n, &B[n1 * ldb], ldb);
                        cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                                    m, n1, n2, -ONE, &B[n1 * ldb], ldb, &A[n1], n, alpha, B, ldb);
                        cblas_dtrsm(CblasColMajor, CblasRight, CblasLower, CblasNoTrans, cblas_diag,
                                    m, n1, ONE, &A[0], n, B, ldb);

                    } else {

                        cblas_dtrsm(CblasColMajor, CblasRight, CblasLower, CblasTrans, cblas_diag,
                                    m, n1, alpha, &A[0], n, B, ldb);
                        cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans,
                                    m, n2, n1, -ONE, B, ldb, &A[n1], n, alpha, &B[n1 * ldb], ldb);
                        cblas_dtrsm(CblasColMajor, CblasRight, CblasUpper, CblasNoTrans, cblas_diag,
