        ...
        while (k >= 0) {
            ...
            if (fmax(absakk, colmax) == ZERO) {
                ...
                if ((kstep == 2) && (p != k)) {
                    ...
                    if (k < n - 1) {
                        cblas_dswap(n - k - 1, &A[k + (k + 1) * lda], lda, &A[p + (k + 1) * lda], lda);
                    }
                }
                ...
                if (kp != kk) {
                    ...
                    if (k < n - 1) {
                        cblas_dswap(n - k - 1, &A[kk + (k + 1) * lda], lda, &A[kp + (k + 1) * lda], lda);
                    }
                }
        ...
        while (k < n) {
            ...
            if (fmax(absakk, colmax) == ZERO) {
                ...
                if ((kstep == 2) && (p != k)) {
                    ...
                    if (k > 0) {
                        cblas_dswap(k, &A[k + 0 * lda], lda, &A[p + 0 * lda], lda);
                    }
                }
                ...
                if (kp != kk) {
                    ...
                    if (k > 0) {
                        cblas_dswap(k, &A[kk + 0 * lda], lda, &A[kp + 0 * lda], lda);
                    }
                }
