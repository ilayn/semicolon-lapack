/**
 * @file dgemlq.c
 * @brief DGEMLQ overwrites matrix C with Q*C, Q^T*C, C*Q, or C*Q^T
 ...
 * elementary reflectors computed by short wide LQ factorization (DGELQ)
 *
