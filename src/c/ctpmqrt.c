/**
 * @file ctpmqrt.c
 * @brief CTPMQRT applies a complex orthogonal matrix Q obtained from a
 ...
 *                        the elementary reflector H(i), as returned by CTPQRT
 *                        in B.
 ...
 */
void ctpmqrt(const char* side, const char* trans, const INT m, const INT n,
