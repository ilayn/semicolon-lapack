/**
 * @file csytri2.c
 * @brief CSYTRI2 computes the inverse of a COMPLEX*16 symmetric indefinite
 *        matrix A using the factorization computed by CSYTRF.
 */
...
/**
 * CSYTRI2 computes the inverse of a COMPLEX*16 symmetric indefinite matrix
