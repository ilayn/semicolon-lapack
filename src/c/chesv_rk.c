/**
 * @file chesv_rk.c
 * @brief CHESV_RK computes the solution to system of linear equations A * X = B for HE matrices using CHETRF_RK/CHETRS_3.
 */
 ...
 *                      factorization routine `chetrf_rk`, i.e. the
 *                      superdiagonal (or subdiagonal) elements of the
 *                      Hermitian block diagonal matrix D with 1-by-1 or
 ...
 *                      of D, as determined by `chetrf_rk`.
 *                      For more info see the description of `chetrf_rk`.
