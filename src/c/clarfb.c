/**
 * @file clarfb.c
 * @brief CLARFB applies a complex block reflector or its conjugate transpose
    ...
    if (storev[0] == 'C' || storev[0] == 'c') {
        if (direct[0] == 'F' || direct[0] == 'f') {
            if (side[0] == 'L' || side[0] == 'l') {
                ...
                /* W := C1**H */
                for (j = 0; j < k; j++) {
                    cblas_ccopy(n, &C[j], ldc, &work[j * ldwork], 1);
                ...
                for (j = 0; j < k; j++) {
                    for (i = 0; i < n; i++) {
                        C[j + i * ldc] -= conjf(work[i + j * ldwork]);
                    }
                }
                ...
                /* W := C1 */
                for (j = 0; j < k; j++) {
                    cblas_ccopy(m, &C[j * ldc], 1, &work[j * ldwork], 1);
                }
            ...
            if (side[0] == 'L' || side[0] == 'l') {
                ...
                for (j = 0; j < k; j++) {
                    for (i = 0; i < n; i++) {
                        C[(m - k + j) + i * ldc] -= conjf(work[i + j * ldwork]);
                    }
                }
        ...
        if (direct[0] == 'F' || direct[0] == 'f') {
            if (side[0] == 'L' || side[0] == 'l') {
                ...
                if (m > k) {
                    /* W := W + C2**H * V2**H */
                    cblas_cgemm(CblasColMajor, CblasConjTrans, CblasConjTrans,
                                n, k, m - k, &ONE,
                                &C[k], ldc, &V[k * ldv], ldv,
                                &ONE, work, ldwork);
                }
