    ...
    *info = 0;
    ...
    if (uplo[0] == 'U' || uplo[0] == 'u') {
        ...
        for (j = (k / nb) * nb; j >= 0; j -= nb) {
            ...
            for (jj = j; jj < j + jb; jj++) {
                A[jj + jj * lda] = crealf(A[jj + jj * lda]);
                cblas_cgemv(CblasColMajor, CblasNoTrans, jj - j + 1, n - k - 1, &NEG_CONE,
            ...
            if (j > 0) {
                cblas_cgemm(CblasColMajor, CblasNoTrans, CblasTrans, j, jb, n - k - 1,
        ...
        *kb = n - 1 - k;
        ...
        for (j = k; j < n; j += nb) {
            ...
            for (jj = j; jj < j + jb; jj++) {
                A[jj + jj * lda] = crealf(A[jj + jj * lda]);
                cblas_cgemv(CblasColMajor, CblasNoTrans, j + jb - jj, k, &NEG_CONE,
            ...
            if (j + jb < n) {
                cblas_cgemm(CblasColMajor, CblasNoTrans, CblasTrans, n - j - jb, jb, k,
