/**
 * @file clatsqr.c
 * @brief CLATSQR computes a blocked Tall-Skinny QR factorization of
 ...
 * @param[out]    T      Single complex array,
             ...
             int* info)
{
    ...
    *info = 0;
    ...
    for (i = mb; i <= ii - mb + n; i += (mb - n)) {
        ...
        ctpqrt(mb - n, n, 0, nb, &A[0], lda, &A[i], lda,
    ...
    if (ii < m) {
        ctpqrt(kk, n, 0, nb, &A[0], lda, &A[ii], lda,
               &T[0 + ctr * n * ldt], ldt, work, info);
    }
