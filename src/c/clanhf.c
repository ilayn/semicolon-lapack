/**
 * @file clanhf.c
 * @brief CLANHF returns the value of the 1-norm, or the Frobenius norm, or
 ...
 *
 * @param[out] work
 *          Single precision array, dimension (MAX(1,LWORK)),
