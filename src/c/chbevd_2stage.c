/**
 * @file chbevd_2stage.c
 * @brief CHBEVD_2STAGE computes the eigenvalues and, optionally, eigenvectors
                   ...
                   INT* info)
{
    ...
    *info = 0;
    ...
    /* Call CHETRD_HB2ST to reduce Hermitian band matrix to tridiagonal form. */
