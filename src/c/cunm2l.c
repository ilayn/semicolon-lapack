/**
 * @file cunm2l.c
 * @brief CUNM2L multiplies a general matrix by the unitary matrix from a
 ...
 *                       as returned by CGEQLF in the last k columns of its
 *                       array argument A.
 ...
 *                       elementary reflector H(i), as returned by CGEQLF.
 ...
 *                                illegal value.
 */
void cunm2l(const char* side, const char* trans,
            ...
            INT* info)
{
    ...
    *info = 0;
    ...
    for (i = i1; i3 > 0 ? i <= i2 : i >= i2; i += i3) {
        ...
        clarf1l(side, mi, ni, &A[0 + i * lda], 1, taui, C, ldc, work);
    }
}
