/**
 * @file clansb.c
 * @brief CLANSB returns the value of the 1-norm, Frobenius norm, infinity norm, or max element of a symmetric band matrix.
 */
