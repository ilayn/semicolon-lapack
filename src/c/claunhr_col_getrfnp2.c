/**
 * @file claunhr_col_getrfnp2.c
 * @brief CLAUNHR_COL_GETRFNP2 computes the modified LU factorization without
                           ...
                           int* info)
{
    ...
    *info = 0;
    ...
    if (m == 1) {
        ...
        D[0] = CMPLXF(-copysignf(ONE, crealf(A[0])), 0.0f);
        ...
        c64 neg_cone = CMPLXF(-1.0f, 0.0f);
        cblas_cgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                    m - n1, n2, n1, &neg_cone, &A[n1], lda,
                    &A[n1 * lda], lda, &CONE, &A[n1 + n1 * lda], lda);

        claunhr_col_getrfnp2(m - n1, n2, &A[n1 + n1 * lda], lda,
                              &D[n1], &iinfo);
