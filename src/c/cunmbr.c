/**
 * @file cunmbr.c
 * @brief CUNMBR multiplies a general matrix by the unitary matrix Q or P
    ...
    *info = 0;
    ...
    if (applyq) {
        ...
        if (nq >= k) {
            ...
            cunmqr(side, trans, mi, ni, nq - 1, &A[1], lda, tau,
        ...
        if (nq > k) {
            ...
            cunmlq(side, transt, m, n, k, A, lda, tau, C, ldc,
                   work, lwork, &iinfo);
        } else if (nq > 1) {
            ...
            cunmlq(side, transt, mi, ni, nq - 1, &A[lda], lda,
