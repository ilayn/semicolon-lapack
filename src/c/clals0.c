            ...
            f32* restrict rwork, INT* info)
{
    ...
    *info = 0;
    ...
    if (icompq == 0) {
        ...
        for (i = 0; i < givptr; i++) {
            cblas_csrot(nrhs, &B[givcol[i + 1 * ldgcol]], ldb,
        ...
        for (i = 1; i < n; i++) {
            cblas_ccopy(nrhs, &B[perm[i]], ldb, &BX[i], ldbx);
        }
            ...
            for (j = 0; j < k; j++) {
                ...
                for (jcol = 0; jcol < nrhs; jcol++) {
                    for (jrow = 0; jrow < k; jrow++) {
                        rwork[i] = crealf(BX[jrow + jcol * ldbx]);
                        i++;
                    }
                }
                ...
                for (jcol = 0; jcol < nrhs; jcol++) {
                    for (jrow = 0; jrow < k; jrow++) {
                        rwork[i] = cimagf(BX[jrow + jcol * ldbx]);
                        i++;
                    }
                }
                cblas_sgemv(CblasColMajor, CblasTrans, k, nrhs, 1.0f,
                ...
                for (jcol = 0; jcol < nrhs; jcol++) {
                    B[j + jcol * ldb] = CMPLXF(rwork[k + jcol],
                                                           rwork[k + nrhs + jcol]);
                }
                clascl("G", 0, 0, temp, 1.0f, 1, nrhs, &B[j], ldb, info);
            }
        }
        ...
        if (k == 1) {
            ...
            for (j = 0; j < k; j++) {
                ...
                for (jcol = 0; jcol < nrhs; jcol++) {
                    for (jrow = 0; jrow < k; jrow++) {
                        rwork[i] = crealf(B[jrow + jcol * ldb]);
                        i++;
                    }
                }
                cblas_sgemv(CblasColMajor, CblasTrans, k, nrhs, 1.0f,
                ...
                for (jcol = 0; jcol < nrhs; jcol++) {
                    for (jrow = 0; jrow < k; jrow++) {
                        rwork[i] = cimagf(B[jrow + jcol * ldb]);
                        i++;
                    }
                }
                cblas_sgemv(CblasColMajor, CblasTrans, k, nrhs, 1.0f,
                            &rwork[k + nrhs * 2], k, rwork, 1, 0.0f, &rwork[k + nrhs], 1);
                for (jcol = 0; jcol < nrhs; jcol++) {
                    BX[j + jcol * ldbx] = CMPLXF(rwork[k + jcol],
                                                              rwork[k + nrhs + jcol]);
                }
            }
        }
        ...
        for (i = 1; i < n; i++) {
            cblas_ccopy(nrhs, &BX[i], ldbx, &B[perm[i]], ldb);
        }
