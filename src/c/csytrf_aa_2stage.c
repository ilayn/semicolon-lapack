/**
 * @file csytrf_aa_2stage.c
 * @brief CSYTRF_AA_2STAGE computes the factorization of a complex symmetric matrix using Aasen's 2-stage algorithm.
 */
 ...
 * @param[out]    TB    Complex array of dimension `max(1,ltb)`.
 ...
 * @param[out]    work  Complex workspace of size `max(1,lwork)`.
