 ...
 * @param[out]    work   Complex*8 array, dimension (`max(1,lwork)`).
    ...
    *info = 0;
    ...
    if (m >= n) {
        ...
        if (m >= mnthr) {
            ...
            if (wntun) {
                ...
                cgeqrf(m, n, A, lda, &work[itau], &work[iwork], lwork - iwork, &ierr);
                ...
                cgebrd(n, n, A, lda, S, &rwork[ie], &work[itauq], &work[itaup],
                       &work[iwork], lwork - iwork, &ierr);
                ncvt = 0;
                if (wntvo || wntvas) {
                    cungbr("P", n, n, n, A, lda, &work[itaup], &work[iwork],
                           lwork - iwork, &ierr);
                    ncvt = n;
                }
                irwork = ie + n;

                cbdsqr("U", n, ncvt, 0, 0, S, &rwork[ie], A, lda,
                ...
                if (lwork >= n*n + 3*n) {
                    ...
                    cungqr(m, n, n, A, lda, &work[itau], &work[iwork], lwork - iwork, &ierr);
                    ...
                    cgebrd(n, n, &work[ir], ldwrkr, S, &rwork[ie], &work[itauq],
                           &work[itaup], &work[iwork], lwork - iwork, &ierr);
                    cungbr("Q", n, n, n, &work[ir], ldwrkr, &work[itauq],
                           &work[iwork], lwork - iwork, &ierr);
                    irwork = ie + n;

                    cbdsqr("U", n, 0, n, 0, S, &rwork[ie], NULL, 1,
                    ...
                    for (i = 0; i < m; i += ldwrku) {
                        ...
                        clacpy("F", chunk, n, &work[iu], ldwrku, &A[i], lda);
                    }
                } else {
                    ie = 0;
                    itauq = 0;
                    ...
                    cgebrd(m, n, A, lda, S, &rwork[ie], &work[itauq],
                           &work[itaup], &work[iwork], lwork - iwork, &ierr);
                    cungbr("Q", m, n, n, A, lda, &work[itauq],
                           &work[iwork], lwork - iwork, &ierr);
                    irwork = ie + n;

                    cbdsqr("U", n, 0, m, 0, S, &rwork[ie], NULL, 1,
                ...
                if (lwork >= n*n + 3*n) {
                    ...
                    if (n > 1) {
                        claset("L", n - 1, n - 1, CZERO, CZERO, &VT[1], ldvt);
                    }
                    cungqr(m, n, n, A, lda, &work[itau], &work[iwork], lwork - iwork, &ierr);
                    ...
                    cgebrd(n, n, VT, ldvt, S, &rwork[ie], &work[itauq],
                           &work[itaup], &work[iwork], lwork - iwork, &ierr);
                    clacpy("L", n, n, VT, ldvt, &work[ir], ldwrkr);
                    cungbr("Q", n, n, n, &work[ir], ldwrkr, &work[itauq],
                           &work[iwork], lwork - iwork, &ierr);
                    cungbr("P", n, n, n, VT, ldvt, &work[itaup],
                           &work[iwork], lwork - iwork, &ierr);
                    irwork = ie + n;

                    cbdsqr("U", n, n, n, 0, S, &rwork[ie], VT, ldvt,
                           &work[ir], ldwrkr, NULL, 1, &rwork[irwork], info);
                    iu = itauq;
                    ...
                    cgebrd(n, n, VT, ldvt, S, &rwork[ie], &work[itauq],
                           &work[itaup], &work[iwork], lwork - iwork, &ierr);
                    cunmbr("Q", "R", "N", m, n, n, VT, ldvt, &work[itauq],
                           A, lda, &work[iwork], lwork - iwork, &ierr);
                    cungbr("P", n, n, n, VT, ldvt, &work[itaup],
                           &work[iwork], lwork - iwork, &ierr);
                    irwork = ie + n;

                    cbdsqr("U", n, n, m, 0, S, &rwork[ie], VT, ldvt,
                           A, lda, NULL, 1, &rwork[irwork], info);
                }
            } else if (wntus) {
                ...
                if (wntvn) {
                    ...
                    if (lwork >= n*n + 3*n) {
                        ...
                        cungqr(m, n, n, U, ldu, &work[itau], &work[iwork], lwork - iwork, &ierr);
                        ...
                        cgebrd(n, n, A, lda, S, &rwork[ie], &work[itauq],
                               &work[itaup], &work[iwork], lwork - iwork, &ierr);
                        cunmbr("Q", "R", "N", m, n, n, A, lda, &work[itauq],
                    ...
                    if (lwork >= 2*n*n + 3*n) {
                        ...
                        cgebrd(n, n, &work[iu], ldwrku, S, &rwork[ie], &work[itauq],
                               &work[itaup], &work[iwork], lwork - iwork, &ierr);
                        ...
                        cbdsqr("U", n, n, n, 0, S, &rwork[ie], &work[ir], ldwrkr,
                        ...
                        cunmbr("Q", "R", "N", m, n, n, A, lda, &work[itauq],
                               U, ldu, &work[iwork], lwork - iwork, &ierr);
                        cungbr("P", n, n, n, A, lda, &work[itaup],
                               &work[iwork], lwork - iwork, &ierr);
                        irwork = ie + n;

                        cbdsqr("U", n, n, m, 0, S, &rwork[ie], A, lda,
                               U, ldu, NULL, 1, &rwork[irwork], info);
                    }
                } else if (wntvas) {
                ...
                if (wntvn) {
                    ...
                    if (lwork >= n*n + ((n + m > 3*n) ? n + m : 3*n)) {
                        ...
                        clacpy("U", n, n, A, lda, &work[ir], ldwrkr);
                        claset("L", n - 1, n - 1, CZERO, CZERO, &work[ir + 1], ldwrkr);
                        cungqr(m, m, n, U, ldu, &work[itau], &work[iwork], lwork - iwork, &ierr);
            ...
            if (wntuas) {
                clacpy("L", m, n, A, lda, U, ldu);
                ncu = wntus ? n : m;
                cungbr("Q", m, ncu, n, U, ldu, &work[itauq], &work[iwork],
                       lwork - iwork, &ierr);
            }
            if (wntvas) {
                clacpy("U", n, n, A, lda, VT, ldvt);
                cungbr("P", n, n, n, VT, ldvt, &work[itaup], &work[iwork],
                       lwork - iwork, &ierr);
            }
            if (wntuo) {
                cungbr("Q", m, n, n, A, lda, &work[itauq], &work[iwork],
                       lwork - iwork, &ierr);
            }
            if (wntvo) {
                cungbr("P", n, n, n, A, lda, &work[itaup], &work[iwork],
            ...
            if (!wntuo && !wntvo) {
                cbdsqr("U", n, ncvt, nru, 0, S, &rwork[ie], VT, ldvt,
                       U, ldu, NULL, 1, &rwork[irwork], info);
            } else if (!wntuo && wntvo) {
                cbdsqr("U", n, ncvt, nru, 0, S, &rwork[ie], A, lda,
                       U, ldu, NULL, 1, &rwork[irwork], info);
            } else {
                cbdsqr("U", n, ncvt, nru, 0, S, &rwork[ie], VT, ldvt,
                       A, lda, NULL, 1, &rwork[irwork], info);
        ...
        if (n >= mnthr) {
            ...
            if (wntvn) {
                ...
                cgelqf(m, n, A, lda, &work[itau], &work[iwork], lwork - iwork, &ierr);

                claset("U", m - 1, m - 1, CZERO, CZERO, &A[lda], lda);
                ie = 0;
                itauq = 0;
                itaup = itauq + m;
                iwork = itaup + m;

                cgebrd(m, m, A, lda, S, &rwork[ie], &work[itauq], &work[itaup],
                       &work[iwork], lwork - iwork, &ierr);

                if (wntuo || wntuas) {
                    cungbr("Q", m, m, m, A, lda, &work[itauq], &work[iwork],
                           lwork - iwork, &ierr);
                }
                irwork = ie + m;
                nru = (wntuo || wntuas) ? m : 0;

                cbdsqr("U", m, 0, nru, 0, S, &rwork[ie], NULL, 1,
                       A, lda, NULL, 1, &rwork[irwork], info);
                ...
                if (lwork >= m*m + 3*m) {
                    ...
                    cunglq(m, n, m, A, lda, &work[itau], &work[iwork], lwork - iwork, &ierr);
                    ...
                    cgebrd(m, m, &work[ir], ldwrkr, S, &rwork[ie], &work[itauq],
                           &work[itaup], &work[iwork], lwork - iwork, &ierr);
                    cungbr("P", m, m, m, &work[ir], ldwrkr, &work[itaup],
                           &work[iwork], lwork - iwork, &ierr);
                    irwork = ie + m;

                    cbdsqr("U", m, m, 0, 0, S, &rwork[ie], &work[ir], ldwrkr,
                           NULL, 1, NULL, 1, &rwork[irwork], info);
                    iu = itauq;
                    ...
                    for (i = 0; i < n; i += chunk) {
                        ...
                        clacpy("F", m, blk, &work[iu], ldwrku, &A[i * (long)lda], lda);
                    }
                } else {
                    ie = 0;
                    itauq = 0;
                    ...
                    cgebrd(m, n, A, lda, S, &rwork[ie], &work[itauq],
                           &work[itaup], &work[iwork], lwork - iwork, &ierr);
                    cungbr("P", m, n, m, A, lda, &work[itaup],
                           &work[iwork], lwork - iwork, &ierr);
                    irwork = ie + m;

                    cbdsqr("L", m, n, 0, 0, S, &rwork[ie], A, lda,
                           NULL, 1, NULL, 1, &rwork[irwork], info);
                }
            } else if (wntvo && wntuas) {
                ...
                if (lwork >= m*m + 3*m) {
                    ...
                    if (m > 1) {
                        claset("U", m - 1, m - 1, CZERO, CZERO, &U[ldu], ldu);
                    }
                    cunglq(m, n, m, A, lda, &work[itau], &work[iwork], lwork - iwork, &ierr);
                    ...
                    cgebrd(m, m, U, ldu, S, &rwork[ie], &work[itauq],
                           &work[itaup], &work[iwork], lwork - iwork, &ierr);
                    clacpy("U", m, m, U, ldu, &work[ir], ldwrkr);
                    cungbr("P", m, m, m, &work[ir], ldwrkr, &work[itaup],
                           &work[iwork], lwork - iwork, &ierr);
                    cungbr("Q", m, m, m, U, ldu, &work[itauq],
                           &work[iwork], lwork - iwork, &ierr);
                    irwork = ie + m;

                    cbdsqr("U", m, m, m, 0, S, &rwork[ie], &work[ir], ldwrkr,
                           U, ldu, NULL, 1, &rwork[irwork], info);
                    iu = itauq;
                    ...
                    cgebrd(m, m, U, ldu, S, &rwork[ie], &work[itauq],
                           &work[itaup], &work[iwork], lwork - iwork, &ierr);
                    cunmbr("P", "L", "C", m, n, m, U, ldu, &work[itaup],
                           A, lda, &work[iwork], lwork - iwork, &ierr);
                    cungbr("Q", m, m, m, U, ldu, &work[itauq],
                           &work[iwork], lwork - iwork, &ierr);
                    irwork = ie + m;

                    cbdsqr("U", m, n, m, 0, S, &rwork[ie], A, lda,
                           U, ldu, NULL, 1, &rwork[irwork], info);
                }
            } else if (wntvs) {
                ...
                if (wntun) {
                    ...
                    if (lwork >= m*m + 3*m) {
                        ...
                        cunglq(m, n, m, VT, ldvt, &work[itau], &work[iwork], lwork - iwork, &ierr);
                        ...
                        cgebrd(m, m, A, lda, S, &rwork[ie], &work[itauq],
                               &work[itaup], &work[iwork], lwork - iwork, &ierr);
                        cunmbr("P", "L", "C", m, n, m, A, lda, &work[itaup],
                               VT, ldvt, &work[iwork], lwork - iwork, &ierr);
                        irwork = ie + m;

                        cbdsqr("U", m, n, 0, 0, S, &rwork[ie], VT, ldvt,
                               NULL, 1, NULL, 1, &rwork[irwork], info);
                    }
                } else if (wntuo) {
                    ...
                    if (lwork >= 2*m*m + 3*m) {
                        ...
                        cgebrd(m, m, &work[iu], ldwrku, S, &rwork[ie], &work[itauq],
                               &work[itaup], &work[iwork], lwork - iwork, &ierr);
                        ...
                        cbdsqr("U", m, m, m, 0, S, &rwork[ie], &work[iu], ldwrku,
                               &work[ir], ldwrkr, NULL, 1, &rwork[irwork], info);
                        ...
                        cunmbr("P", "L", "C", m, n, m, A, lda, &work[itaup],
                               VT, ldvt, &work[iwork], lwork - iwork, &ierr);
                        cungbr("Q", m, m, m, A, lda, &work[itauq],
                               &work[iwork], lwork - iwork, &ierr);
                        irwork = ie + m;

                        cbdsqr("U", m, n, m, 0, S, &rwork[ie], VT, ldvt,
                               A, lda, NULL, 1, &rwork[irwork], info);
                    }
                } else if (wntuas) {
                ...
                if (wntun) {
                    ...
                    if (lwork >= m*m + ((n + m > 3*m) ? n + m : 3*m)) {
                        ...
                        clacpy("L", m, m, A, lda, &work[ir], ldwrkr);
                        claset("U", m - 1, m - 1, CZERO, CZERO, &work[ir + ldwrkr], ldwrkr);
                        cunglq(n, n, m, VT, ldvt, &work[itau], &work[iwork], lwork - iwork, &ierr);
            ...
            if (wntuas) {
                clacpy("L", m, m, A, lda, U, ldu);
                cungbr("Q", m, m, n, U, ldu, &work[itauq], &work[iwork],
                       lwork - iwork, &ierr);
            }
            if (wntvas) {
                clacpy("U", m, n, A, lda, VT, ldvt);
                nrvt = wntva ? n : m;
                cungbr("P", nrvt, n, m, VT, ldvt, &work[itaup], &work[iwork],
                       lwork - iwork, &ierr);
            }
            if (wntuo) {
                cungbr("Q", m, m, n, A, lda, &work[itauq], &work[iwork],
                       lwork - iwork, &ierr);
            }
            if (wntvo) {
                cungbr("P", m, n, m, A, lda, &work[itaup], &work[iwork],
                       lwork - iwork, &ierr);
            }
            ...
            if (!wntuo && !wntvo) {
                cbdsqr("L", m, ncvt, nru, 0, S, &rwork[ie], VT, ldvt,
                       U, ldu, NULL, 1, &rwork[irwork], info);
            } else if (!wntuo && wntvo) {
                cbdsqr("L", m, ncvt, nru, 0, S, &rwork[ie], A, lda,
                       U, ldu, NULL, 1, &rwork[irwork], info);
            } else {
                cbdsqr("L", m, ncvt, nru, 0, S, &rwork[ie], VT, ldvt,
                       A, lda, NULL, 1, &rwork[irwork], info);
    ...
    if (iscl == 1) {
        ...
        if (*info != 0 && anrm > bignum) {
            slascl("G", 0, 0, bignum, anrm, minmn - 1, 1, &rwork[ie], minmn, &ierr);
        }
        if (anrm < smlnum) {
            slascl("G", 0, 0, smlnum, anrm, minmn, 1, S, minmn, &ierr);
        }
        if (*info != 0 && anrm < smlnum) {
            slascl("G", 0, 0, smlnum, anrm, minmn - 1, 1, &rwork[ie], minmn, &ierr);
        }
    }
