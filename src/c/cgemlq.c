/**
 * @file cgemlq.c
 * @brief CGEMLQ overwrites matrix C with Q*C, Q^H*C, C*Q, or C*Q^H
 *        where Q is defined by an LQ factorization from CGELQ.
 */
 ...
 * elementary reflectors computed by short wide LQ factorization (CGELQ)
 *
