/**
 * @file cungtr.c
 * @brief CUNGTR generates a complex unitary matrix Q which is defined as the
 ...
 * @param[in]     tau    Complex*16 array, dimension (n-1).
 ...
 */
void cungtr(const char* uplo, const INT n,
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        if (n > 1) {
            ...
            cungqr(n - 1, n - 1, n - 1, &A[1 + 1 * lda], lda, tau,
                   work, lwork, &iinfo);
        }
    }
