/**
 * @file cgesdd.c
 * @brief CGESDD computes the singular value decomposition (SVD) of a complex
    ...
    *info = 0;
    ...
    if (m >= n) {
        ...
        if (m >= mnthr1) {
            ...
            if (wntqn) {
                ...
                sbdsdc("U", "N", n, S, &rwork[ie], NULL, 1, NULL, 1,
                ...
                claset("L", n - 1, n - 1, CZERO, CZERO, &work[ir + 1],
                       ldwrkr);

                cungqr(m, n, n, A, lda, &work[itau], &work[nwork],
                       lwork - nwork, &ierr);
                ie = 0;
                itauq = itau;
                itaup = itauq + n;
                ...
                cunmbr("Q", "L", "N", n, n, n, &work[ir], ldwrkr,
                       &work[itauq], &work[iu], ldwrku,
                       &work[nwork], lwork - nwork, &ierr);

                clacp2("F", n, n, &rwork[irvt], n, VT, ldvt);
                cunmbr("P", "R", "C", n, n, n, &work[ir], ldwrkr,
                ...
                for (i = 0; i < m; i += ldwrkr) {
                    ...
                    clacpy("F", chunk, n, &work[ir], ldwrkr, &A[i], lda);
                }
                ...
                cungqr(m, m, n, U, ldu, &work[itau], &work[nwork],
                       lwork - nwork, &ierr);
                ...
                clacp2("F", n, n, &rwork[iru], n, &work[iu], ldwrku);
                cunmbr("Q", "L", "N", n, n, n, A, lda,
                       &work[itauq], &work[iu], ldwrku,
                       &work[nwork], lwork - nwork, &ierr);

                clacp2("F", n, n, &rwork[irvt], n, VT, ldvt);
                cunmbr("P", "R", "C", n, n, n, A, lda,
                       &work[itaup], VT, ldvt, &work[nwork],
                       lwork - nwork, &ierr);
            ...
            if (wntqn) {
                ...
                for (i = 0; i < m; i += ldwrku) {
                    ...
                    clacrm(chunk, n, &A[i], lda, &rwork[iru],
                           n, &work[iu], ldwrku, &rwork[nrwork]);
                    clacpy("F", chunk, n, &work[iu], ldwrku,
                           &A[i], lda);
                }
                ...
                clacpy("L", m, n, A, lda, U, ldu);
                cungbr("Q", m, n, n, U, ldu, &work[itauq],
                       &work[nwork], lwork - nwork, &ierr);
                ...
                clacpy("L", m, n, A, lda, U, ldu);
                cungbr("Q", m, m, n, U, ldu, &work[itauq],
                       &work[nwork], lwork - nwork, &ierr);
            ...
            if (wntqn) {
                ...
                if (m > n) {
                    claset("F", m - n, m - n, CZERO, CONE,
                           &U[n + n * ldu], ldu);
                }

                clacp2("F", n, n, &rwork[iru], n, U, ldu);
                cunmbr("Q", "L", "N", m, m, n, A, lda,
                       &work[itauq], U, ldu, &work[nwork],
                       lwork - nwork, &ierr);
        ...
        if (n >= mnthr1) {
            ...
            if (wntqn) {
                ...
                sbdsdc("U", "N", m, S, &rwork[ie], NULL, 1, NULL, 1,
                       NULL, NULL, &rwork[nrwork], iwork, info);
                ...
                claset("U", m - 1, m - 1, CZERO, CZERO,
                       &work[il + ldwrkl], ldwrkl);

                cunglq(m, n, m, A, lda, &work[itau], &work[nwork],
                       lwork - nwork, &ierr);
                ie = 0;
                itauq = itau;
                itaup = itauq + m;
                ...
                irvt = iru + m * m;
                nrwork = irvt + m * m;
                sbdsdc("U", "I", m, S, &rwork[ie], &rwork[iru],
                       m, &rwork[irvt], m, NULL, NULL,
                       &rwork[nrwork], iwork, info);

                clacp2("F", m, m, &rwork[iru], m, U, ldu);
                cunmbr("Q", "L", "N", m, m, m, &work[il], ldwrkl,
                       &work[itauq], U, ldu, &work[nwork],
                       lwork - nwork, &ierr);

                clacp2("F", m, m, &rwork[irvt], m, &work[ivt], ldwkvt);
                cunmbr("P", "R", "C", m, m, m, &work[il], ldwrkl,
                ...
                for (i = 0; i < n; i += chunk) {
                    ...
                    clacpy("F", m, blk, &work[il], ldwrkl, &A[i * lda], lda);
                }
                ...
                cunglq(n, n, m, VT, ldvt, &work[itau], &work[nwork],
                       lwork - nwork, &ierr);
                ...
                clacp2("F", m, m, &rwork[iru], m, U, ldu);
                cunmbr("Q", "L", "N", m, m, m, A, lda,
                       &work[itauq], U, ldu, &work[nwork],
                       lwork - nwork, &ierr);

                clacp2("F", m, m, &rwork[irvt], m, &work[ivt], ldwkvt);
                cunmbr("P", "R", "C", m, m, m, A, lda,
                       &work[itaup], &work[ivt], ldwkvt,
                       &work[nwork], lwork - nwork, &ierr);
            ...
            if (wntqn) {
                ...
                /* Path 5tn (N >> M, JOBZ='N') */
                sbdsdc("L", "N", m, S, &rwork[ie], NULL, 1, NULL, 1,
                       NULL, NULL, &rwork[nrwork], iwork, info);
            } else if (wntqo) {
                irvt = nrwork;
                iru = irvt + m * m;
                ...
                for (i = 0; i < n; i += chunk) {
                    blk = ((n - i) < chunk) ? (n - i) : chunk;
                    clarcm(m, blk, &rwork[irvt], m, &A[i * lda],
                           lda, &work[ivt], ldwkvt, &rwork[nrwork]);
                    clacpy("F", m, blk, &work[ivt], ldwkvt,
                           &A[i * lda], lda);
                }
            } else if (wntqs) {
                ...
                clacpy("U", m, n, A, lda, VT, ldvt);
                cungbr("P", m, n, m, VT, ldvt, &work[itaup],
                       &work[nwork], lwork - nwork, &ierr);
                ...
                clacpy("U", m, n, A, lda, VT, ldvt);
                cungbr("P", n, n, m, VT, ldvt, &work[itaup],
                       &work[nwork], lwork - nwork, &ierr);
            ...
            if (wntqn) {
                ...
                if (lwork >= m * n + 3 * m) {
                    ...
                    /* Path 6to-fast */
                    clacp2("F", m, m, &rwork[irvt], m, &work[ivt],
                           ldwkvt);
                    cunmbr("P", "R", "C", m, n, m, A, lda,
                           &work[itaup], &work[ivt], ldwkvt,
                           &work[nwork], lwork - nwork, &ierr);
    ...
    if (iscl == 1) {
        ...
        if (*info != 0 && anrm > bignum) {
            slascl("G", 0, 0, bignum, anrm, minmn - 1, 1,
                   &rwork[ie], minmn, &ierr);
        }
        if (anrm < smlnum) {
        ...
        if (*info != 0 && anrm < smlnum) {
            slascl("G", 0, 0, smlnum, anrm, minmn - 1, 1,
                   &rwork[ie], minmn, &ierr);
        }
    }
