/**
 * @file csycon.c
 * @brief CSYCON estimates the reciprocal of the condition number of a
 ...
 *                       of D as determined by CSYTRF. Integer array, dimension (n).
    ...
    int* info)
{
    ...
    *rcond = ZERO;
    ...
    for (;;) {
        ...
        csytrs(uplo, n, 1, A, lda, ipiv, work, n, &linfo);
    }
