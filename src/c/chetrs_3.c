/**
 * @file chetrs_3.c
 * @brief CHETRS_3 solves a system of linear equations A*X = B with a complex Hermitian matrix using the factorization computed by CHETRF_RK or CHETRF_BK.
 */
 ...
 *                      U or L as computed by `chetrf_rk` or `chetrf_bk`:
