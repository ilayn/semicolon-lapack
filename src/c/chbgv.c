/**
 * @file chbgv.c
 * @brief CHBGV computes all eigenvalues and, optionally, eigenvectors of a
 ...
 * @param[out]    rwork  Single precision array, dimension (3*n).
    ...
    INT* info)
{
    ...
    *info = 0;
    ...
    chbtrd(&vect, uplo, n, ka, AB, ldab, W, &rwork[inde], Z, ldz,
           work, &iinfo);
