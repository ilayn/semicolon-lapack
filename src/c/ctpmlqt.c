/**
 * @file ctpmlqt.c
 * @brief CTPMLQT applies a complex unitary matrix Q obtained from a
 ...
 *                        the elementary reflector H(i), as returned by CTPLQT
 *                        in B.
