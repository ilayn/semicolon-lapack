/**
 * @file ctbrfs.c
 * @brief CTBRFS provides error bounds and backward error estimates for triangular banded systems.
 */
    ...
    *info = 0;
    ...
    for (j = 0; j < nrhs; j++) {
        ...
        do {
            ...
            if (kase != 0) {
                if (kase == 1) {
                    cblas_ctbsv(CblasColMajor, cblas_uplo, cblas_transt, cblas_siag,
                                n, kd, AB, ldab, work, 1);
                    for (i = 0; i < n; i++) {
                    ...
                    cblas_ctbsv(CblasColMajor, cblas_uplo, cblas_transn, cblas_siag,
                                n, kd, AB, ldab, work, 1);
                }
            }
        } while (kase != 0);
