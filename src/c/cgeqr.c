/**
 * @file cgeqr.c
 * @brief CGEQR computes a QR factorization of a complex M-by-N matrix A.
 */
 ...
 * @param[out]    T      Single complex array, dimension (max(5, tsize)).
 ...
 */
void cgeqr(const INT m, const INT n,
