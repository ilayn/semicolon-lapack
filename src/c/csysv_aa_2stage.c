/**
 * @file csysv_aa_2stage.c
 * @brief CSYSV_AA_2STAGE computes the solution to system of linear equations A * X = B for SY matrices using Aasen's 2-stage algorithm.
 */
    ...
    INT* info)
{
    ...
    *info = 0;
    ...
    if (*info == 0) {
        ...
        lwkopt = (lwkmin > (INT)crealf(work[0])) ? lwkmin : (INT)crealf(work[0]);
        work[0] = (c64)lwkopt;
    }
