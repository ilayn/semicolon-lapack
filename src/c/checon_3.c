/**
 * @file checon_3.c
 * @brief CHECON_3 estimates the reciprocal of the condition number of a Hermitian matrix using the factorization computed by CHETRF_RK or CHETRF_BK.
 */
 ...
 *                      U or L as computed by `chetrf_rk` and `chetrf_bk`:
