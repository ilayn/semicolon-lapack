/**
 * @file cgesvx.c
 * @brief CGESVX computes the solution to a complex system of linear equations
    ...
    INT* info)
{
    ...
    *info = 0;
    ...
    cgerfs(trans, n, nrhs, A, lda, AF, ldaf, ipiv, B, ldb, X, ldx,
