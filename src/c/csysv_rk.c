/**
 * @file csysv_rk.c
 * @brief CSYSV_RK computes the solution to system of linear equations A * X = B for SY matrices using CSYTRF_RK/CSYTRS_3.
 */
 ...
 *                      factorization routine `csytrf_rk`, i.e. the
 ...
 *                      of D, as determined by `csytrf_rk`.
 *
 *                      For more info see the description of `csytrf_rk`.
