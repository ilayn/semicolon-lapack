            ...
            if (normaltransr) {
                ...
                if (lower) {
                    ...
                    if (notrans) {
                        ...
                        if (m == 1) {
                            cblas_ctrsm(CblasColMajor, CblasLeft, CblasLower, CblasNoTrans, cblas_siag,
                            ...
                            cblas_ctrsm(CblasColMajor, CblasLeft, CblasUpper, CblasConjTrans, cblas_siag,
                        ...
                        if (m == 1) {
                            cblas_ctrsm(CblasColMajor, CblasLeft, CblasLower, CblasConjTrans, cblas_siag,
                                        m1, n, &alpha, &A[0], m, B, ldb);
                        } else {
                            cblas_ctrsm(CblasColMajor, CblasLeft, CblasUpper, CblasNoTrans, cblas_siag,
            ...
            if (normaltransr) {
                ...
                if (lower) {
                    ...
                    if (notrans) {
                        ...
                        cblas_ctrsm(CblasColMajor, CblasRight, CblasUpper, CblasConjTrans, cblas_siag,
                                    m, n2, &alpha, &A[n], n, &B[n1 * ldb], ldb);
                        cblas_cgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                                    m, n1, n2, &NEG_CONE, &B[n1 * ldb], ldb, &A[n1], n, &alpha, B, ldb);
                        cblas_ctrsm(CblasColMajor, CblasRight, CblasLower, CblasNoTrans, cblas_siag,
                                    m, n1, &CONE, &A[0], n, B, ldb);

                    } else {

                        cblas_ctrsm(CblasColMajor, CblasRight, CblasLower, CblasConjTrans, cblas_siag,
                        ...
                        cblas_ctrsm(CblasColMajor, CblasRight, CblasUpper, CblasNoTrans, cblas_siag,
