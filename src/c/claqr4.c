/**
 * @file claqr4.c
 * @brief CLAQR4 computes eigenvalues of a Hessenberg matrix using small-bulge
 ...
 * QR algorithm. It is identical to CLAQR0 except that it calls CLAQR2
 * instead of CLAQR3.
 *
 ...
 *                    > 0: if info = i (1-based), CLAQR4 failed to compute
 *                         all eigenvalues.
 */
    ...
    *info = 0;
    ...
    if (n <= ntiny) {
        ...
        *info = 0;
        ...
        claqr2(wantt, wantz, n, ilo, ihi, nwr + 1, H, ldh, iloz,
