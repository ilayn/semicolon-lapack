/**
 * @file cunmql.c
 * @brief CUNMQL multiplies a general matrix by the unitary matrix from
    ...
    *info = 0;
    ...
    if (nb < nbmin || nb >= k) {
        ...
        for (i = i1; i3 > 0 ? i <= i2 : i >= i2; i += i3) {
            ...
            /* Apply H or H^H */
            clarfb(side, trans, "B", "C", mi, ni, ib,
                   &A[0 + i * lda], lda,
                   &work[iwt], LDT,
                   C, ldc,
                   work, ldwork);
