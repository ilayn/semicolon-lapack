/**
 * @file cungbr.c
 * @brief CUNGBR generates one of the unitary matrices Q or P**H
 ...
 */
void cungbr(const char* vect, const INT m, const INT n, const INT k,
    ...
    if (*info == 0) {
        ...
        if (wantq) {
            if (m >= k) {
                ...
                if (m > 1) {
                    cungqr(m - 1, m - 1, m - 1, A, lda, tau, work, -1,
                           &iinfo);
                }
            }
        } else {
            if (k < n) {
                ...
                if (n > 1) {
                    cunglq(n - 1, n - 1, n - 1, A, lda, tau, work, -1,
                           &iinfo);
                }
            }
        }
    ...
    if (wantq) {
        ...
        if (m >= k) {
            ...
            if (m > 1) {
                ...
                cungqr(m - 1, m - 1, m - 1, &A[1 + 1 * lda], lda, tau,
                       work, lwork, &iinfo);
            }
        }
    } else {
        ...
        if (k < n) {
            ...
            if (n > 1) {
                ...
                cunglq(n - 1, n - 1, n - 1, &A[1 + 1 * lda], lda, tau,
                       work, lwork, &iinfo);
            }
        }
    }
