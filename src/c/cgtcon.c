...
/**
 * @file cgtcon.c
 * @brief CGTCON estimates the reciprocal of the condition number of a
    ...
    *rcond = ZERO;
    ...
    for (;;) {
        ...
        if (kase == kase1) {
            ...
            cgttrs("N", n, 1, DL, D, DU, DU2, ipiv, work, ldb, info);
        } else {
            /* Multiply by inv(L**H)*inv(U**H) */
            cgttrs("C", n, 1, DL, D, DU, DU2, ipiv, work, ldb, info);
        }
    }
