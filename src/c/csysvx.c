/**
 * @file csysvx.c
 * @brief CSYSVX computes the solution to a complex system of linear equations
 ...
 * @param[in,out] AF    If fact = 'F', contains the factored form from CSYTRF.
 ...
 * @param[in,out] ipiv  If fact = 'F', contains the pivot indices from CSYTRF.
 ...
 *                      Complex*16 array, dimension (ldx, nrhs).
    ...
    int* info)
{
    ...
    *info = 0;
    ...
    csyrfs(uplo, n, nrhs, A, lda, AF, ldaf, ipiv, B, ldb, X, ldx,
