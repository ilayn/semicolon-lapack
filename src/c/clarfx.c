/**
 * @file clarfx.c
 * @brief CLARFX applies an elementary reflector to a general rectangular
            ...
            c64* restrict work)
{
    ...
    if (side[0] == 'L' || side[0] == 'l') {
        ...
        default:
            /* Code for general m */
            clarf("L", m, n, v, 1, tau, C, ldc, work);
            break;
        }
        ...
        default:
            /* Code for general n */
            clarf("R", m, n, v, 1, tau, C, ldc, work);
            break;
        }
    }
}
