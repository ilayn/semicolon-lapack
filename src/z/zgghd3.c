    ...
    INT* info)
{
    ...
    *info = 0;
    ...
    if (nb < nbmin || nb >= nh) {
        ...
        for (jcol = ilo; jcol <= ihi - 2; jcol += nb) {
            ...
            for (j = jcol; j < jcol + nnb; j++) {
                ...
                for (jj = n - 1; jj >= j + 1; jj--) {
                    ...
                    if (jj < ihi) {
                        ...
                        zlartg(temp, B[jj + 1 + jj * ldb], &c, &s,
                               &B[jj + 1 + (jj + 1) * ldb]);
                        B[jj + 1 + jj * ldb] = CZERO;
                        zrot(jj + 1 - top, &B[top + (jj + 1) * ldb], 1,
                             &B[top + jj * ldb], 1, c, s);
                ...
                if (j < jcol + nnb - 1) {
                    ...
                    jrow = ihi - nblst + 1;
                    cblas_zgemv(CblasColMajor, CblasConjTrans, nblst, len, &CONE,
                    ...
                    cblas_zgemv(CblasColMajor, CblasConjTrans, len, nblst - len,
                                &CONE,
                    ...
                    for (jrow = j0; jrow >= jcol + 1; jrow -= nnb) {
                        ...
                        cblas_ztrmv(CblasColMajor, CblasUpper, CblasConjTrans,
                                    CblasNonUnit, len,
                                    &work[ppwo + nnb], 2 * nnb,
                                    &work[pw], 1);
                        cblas_ztrmv(CblasColMajor, CblasLower, CblasConjTrans,
            ...
            cblas_zgemm(CblasColMajor, CblasConjTrans, CblasNoTrans,
                        ...
                        &work[pw], nblst);
            zlacpy("A", nblst, cola, &work[pw], nblst,
            ...
            if (wantz || top > 0) {
                ...
                pw = nblst * nblst;
                for (i = 0; i < n2nb; i++) {
                    zlaset("A", 2 * nnb, 2 * nnb, CZERO, CONE,
                           &work[pw], 2 * nnb);
                    pw += 4 * nnb * nnb;
                }
                ...
                zlaset("L", ihi - jcol - 1, nnb, CZERO, CZERO,
            ...
            if (top > 0) {
                ...
                cblas_zgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                            ...
                            &work[pw], top);
                zlacpy("A", top, nblst, &work[pw], top,
                       &A[j * lda], lda);
                ppwo = nblst * nblst;
                j0 = j - nnb;
                for (j = j0; j >= jcol + 1; j -= nnb) {
                    if (blk22) {
                        ...
                        cblas_zgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                                    ...
                                    &work[ppwo], 2 * nnb, &CZERO,
                                    &work[pw], top);
                        zlacpy("A", top, 2 * nnb, &work[pw], top,
                               &A[j * lda], lda);
                    }
                    ppwo += 4 * nnb * nnb;
                }
...

    {
        ...
        if (jcol < ihi)
            zgghrd(compq2, compz2, n, jcol, ihi, A, lda, B, ldb,
                   Q, ldq, Z, ldz, &ierr);
    }
