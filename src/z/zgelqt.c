/**
 * @file zgelqt.c
 * @brief ZGELQT computes a blocked LQ factorization of a general M-by-N matrix
 ...
 * @param[out]    T     Double complex array, dimension (ldt, min(m,n)).
            ...
            INT* info)
{
    ...
    *info = 0;
    ...
    for (i = 0; i < k; i += mb) {
        ...
        zgelqt3(ib, n - i, &A[i + i * lda], lda, &T[0 + i * ldt], ldt, &iinfo);
