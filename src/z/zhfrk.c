/**
 * @file zhfrk.c
 * @brief ZHFRK performs a Hermitian rank-k operation for matrix in RFP format.
 */
 ...
 *
 * @param[in] A
 *          Double complex array, dimension (lda, ka)
    ...
    double complex* const restrict C)
{
    ...
    calpha = CMPLX(alpha, 0.0);
    cbeta = CMPLX(beta, 0.0);
