        ...
        while (k < n) {
            ...
            if (ipiv[k] >= 0) {
                ...
                if (k > 0) {
                    ...
                    zspmv(uplo, k, -ONE, AP, work, 1, ZERO, &AP[kcnext], 1);
                    cblas_zdotu_sub(k, work, 1, &AP[kcnext], 1, &dotval);
        ...
        while (k >= 0) {
            ...
            if (ipiv[k] >= 0) {
                ...
                if (k < n - 1) {
                    ...
                    zspmv(uplo, n - k - 1, -ONE, &AP[kc + n - k], work, 1, ZERO, &AP[kcnext + 2], 1);
                    cblas_zdotu_sub(n - k - 1, work, 1, &AP[kcnext + 2], 1, &dotval);
