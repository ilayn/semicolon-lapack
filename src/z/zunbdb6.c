/**
 * @file zunbdb6.c
 * @brief ZUNBDB6 orthogonalizes a column vector with respect to an
             ...
             int* info)
{
    ...
    *info = 0;
    ...
    if (m1 == 0) {
        ...
        cblas_zgemv(CblasColMajor, CblasConjTrans, m1, n, &ONE, Q1, ldq1,
                    X1, incx1, &ZERO, work, 1);
    }

    cblas_zgemv(CblasColMajor, CblasConjTrans, m2, n, &ONE, Q2, ldq2,
                X2, incx2, &ONE, work, 1);

    cblas_zgemv(CblasColMajor, CblasNoTrans, m1, n, &NEGONE, Q1, ldq1,
                work, 1, &ONE, X1, incx1);
    cblas_zgemv(CblasColMajor, CblasNoTrans, m2, n, &NEGONE, Q2, ldq2,
                work, 1, &ONE, X2, incx2);
