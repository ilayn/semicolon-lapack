 ...
 * @param[out]    work  Complex double precision workspace for residual vectors.
 *                      Array of dimension (`n`, `nrhs`).
 * @param[out]    swork Complex single precision workspace for the matrix and the
 ...
 *                           i of (COMPLEX*16) A is not positive, so the
