/**
 * @file zhecon.c
 * @brief ZHECON estimates the reciprocal of the condition number of a
...
/**
 * ZHECON estimates the reciprocal of the condition number (in the
 ...
 *                       of D as determined by ZHETRF. Integer array, dimension (n).
    ...
    int* info)
{
    ...
    *rcond = ZERO;
    ...
    for (;;) {
        ...
        zhetrs(uplo, n, 1, A, lda, ipiv, work, n, &linfo);
    }
