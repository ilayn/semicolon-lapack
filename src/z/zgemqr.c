/**
 * @file zgemqr.c
 * @brief ZGEMQR overwrites matrix C with Q*C, Q^H*C, C*Q, or C*Q^H
 ...
 */
void zgemqr(const char* side, const char* trans,
            ...
            int* info)
{
    ...
    /* Read block sizes from T array (stored by ZGEQR) */
    mb = (int)creal(T[1]);
    nb = (int)creal(T[2]);
