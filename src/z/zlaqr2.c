/**
 * @file zlaqr2.c
 * @brief ZLAQR2 performs aggressive early deflation.
 */
...
/**
 * ZLAQR2 performs the unitary similarity transformation of a Hessenberg
 * matrix to detect and deflate fully converged eigenvalues from a trailing
 * principal submatrix (aggressive early deflation).
 *
 * ZLAQR2 is identical to ZLAQR3 except that it avoids recursion by calling
 * ZLAHQR instead of ZLAQR4.
 *
