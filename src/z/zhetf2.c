 ...
 *
 * @param[in]     uplo
 *                       - `'U'`: Upper triangular factorization (A = U*D*U**H)
        ...
        while (k >= 0) {
            ...
            if (fmax(absakk, colmax) == 0.0 || isnan(absakk)) {
                ...
                if (kstep == 1) {
                    ...
                    if (k > 1) {
                        f64 d = dlapy2(creal(A[(k - 1) + k * lda]),
                                          cimag(A[(k - 1) + k * lda]));
                        f64 d22 = creal(A[(k - 1) + (k - 1) * lda]) / d;
                        f64 d11 = creal(A[k + k * lda]) / d;
                        f64 tt = 1.0 / (d11 * d22 - 1.0);
            ...
            if (fmax(absakk, colmax) == 0.0 || isnan(absakk)) {
                ...
                if (kstep == 1) {
                    ...
                    if (k < n - 2) {
                        f64 d = dlapy2(creal(A[(k + 1) + k * lda]),
                                          cimag(A[(k + 1) + k * lda]));
                        f64 d11 = creal(A[(k + 1) + (k + 1) * lda]) / d;
                        f64 d22 = creal(A[k + k * lda]) / d;
                        f64 tt = 1.0 / (d11 * d22 - 1.0);
