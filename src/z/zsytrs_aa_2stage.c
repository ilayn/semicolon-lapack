/**
 * @file zsytrs_aa_2stage.c
 * @brief ZSYTRS_AA_2STAGE solves a system of linear equations A*X = B using the factorization computed by ZSYTRF_AA_2STAGE.
 */
 ...
 * @param[in]     TB    Complex array of dimension `ltb`.
 *                      Details of factors computed by `zsytrf_aa_2stage`.
 * @param[in]     ltb   The size of the array TB. `ltb>=4*n`.
 * @param[in]     ipiv  Array of dimension `n`.
 *                      Details of the interchanges as computed by
 *                      `zsytrf_aa_2stage`.
 * @param[in]     ipiv2 Array of dimension `n`.
 *                      Details of the interchanges as computed by
 *                      `zsytrf_aa_2stage`.
