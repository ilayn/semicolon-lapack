/**
 * @file zunmr3.c
 * @brief ZUNMR3 multiplies a general matrix by the unitary matrix from a RZ
 ...
 *                         as returned by ZTZRZF in the last k rows of its
 *                         array argument A.
 ...
 *                         elementary reflector H(i), as returned by ZTZRZF.
            ...
            c128* restrict work, int* info)
{
    ...
    *info = 0;
    ...
    for (i = i1; i != i2; i += i3) {
        ...
        zlarz(side, mi, ni, l, &A[i + ja * lda], lda, taui,
