/**
 * @file zgelqt3.c
 * @brief ZGELQT3 recursively computes a LQ factorization of a general
             ...
             int* info)
{
    ...
    *info = 0;
    ...
    if (m == 1) {
        ...
        zlarfg(n, &A[0], &A[0 + (1 < n ? 1 : 0) * lda], lda, &T[0]);
        T[0] = conj(T[0]);
        ...
        cblas_ztrmm(CblasColMajor, CblasRight, CblasUpper, CblasConjTrans, CblasUnit,
        ...
        zgelqt3(m2, n - m1, &A[i1 + i1 * lda], lda,
