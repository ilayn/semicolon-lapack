/**
 * @file zunmhr.c
 * @brief ZUNMHR overwrites matrix C with Q*C or C*Q or their conjugate
 ...
 * @param[in] ilo     Index ilo from ZGEHRD (0-based).
 * @param[in] ihi     Index ihi from ZGEHRD (0-based).
 * @param[in] A       Array containing the elementary reflectors from ZGEHRD.
 * @param[in] lda     Leading dimension of A.
 * @param[in] tau     Array of scalar factors from ZGEHRD.
