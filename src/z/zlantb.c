/**
 * @file zlantb.c
 * @brief ZLANTB returns the value of the 1-norm, Frobenius norm,
            ...
            if (udiag) {
                ...
                if (k > 0) {
                    for (j = 1; j < n; j++) {
                        ...
                        zlassq(count, &AB[start + j * ldab], 1, &scale, &sum);
                    }
                }
            } else {
                scale = ZERO;
            ...
            if (udiag) {
                ...
                if (k > 0) {
                    for (j = 0; j < n - 1; j++) {
                        ...
                        zlassq(count, &AB[1 + j * ldab], 1, &scale, &sum);
                    }
                }
            } else {
                scale = ZERO;
                ...
                for (j = 0; j < n; j++) {
                    ...
                    zlassq(count, &AB[j * ldab], 1, &scale, &sum);
                }
            }
        }
