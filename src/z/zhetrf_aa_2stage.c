...
/**
 * ZHETRF_AA_2STAGE computes the factorization of a complex Hermitian
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        for (j = 0; j < nt; j++) {
            ...
            for (i = 0; i < kb; i++) {
                TB[td + (j * nb + i) * ldtb] = creal(TB[td + (j * nb + i) * ldtb]);
                for (k = i + 1; k < kb; k++) {
                    TB[td + (k - i) + (j * nb + i) * ldtb] =
                        conj(TB[td - (k - i) + (j * nb + k) * ldtb]);
                }
            }
                    ...
                    if (i1 != i2) {
                        ...
                        if (i2 > i1 + 1) {
                            cblas_zswap(i2 - i1 - 1, &A[i1 + (i1 + 1) * lda], lda,
                                        &A[i1 + 1 + i2 * lda], 1);
                            zlacgv(i2 - i1 - 1, &A[i1 + 1 + i2 * lda], 1);
                        }
                        zlacgv(i2 - i1, &A[i1 + (i1 + 1) * lda], lda);
                        if (i2 < n - 1) {
                    ...
                    if (i1 != i2) {
                        ...
                        if (i2 > i1 + 1) {
                            cblas_zswap(i2 - i1 - 1, &A[i1 + 1 + i1 * lda], 1,
                                        &A[i2 + (i1 + 1) * lda], lda);
                            zlacgv(i2 - i1 - 1, &A[i2 + (i1 + 1) * lda], lda);
                        }
                        zlacgv(i2 - i1, &A[i1 + 1 + i1 * lda], 1);
                        if (i2 < n - 1) {
