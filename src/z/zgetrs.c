    ...
    INT* info)
{
    ...
    *info = 0;
    ...
    if (notran) {
        ...
        zlaswp(nrhs, B, ldb, 0, n - 1, ipiv, 1);
        ...
        cblas_ztrsm(CblasColMajor, CblasLeft, CblasUpper, cblas_trans, CblasNonUnit,
                    n, nrhs, &ONE, A, lda, B, ldb);

        // Solve L**T *X = B, or L**H *X = B overwriting B with X.
        cblas_ztrsm(CblasColMajor, CblasLeft, CblasLower, cblas_trans, CblasUnit,
                    n, nrhs, &ONE, A, lda, B, ldb);
