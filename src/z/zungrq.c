/**
 * @file zungrq.c
 * @brief ZUNGRQ generates all or part of the unitary matrix Q from
 *        an RQ factorization determined by ZGERQF (blocked algorithm).
 */
