/**
 * @file zsytri.c
 * @brief ZSYTRI computes the inverse of a complex symmetric indefinite matrix
 ...
 *                      On entry, the factored matrix from ZSYTRF.
    ...
    if (upper) {
        ...
        while (k < n) {
            ...
            if (kp != k) {
                ...
                if (k - kp - 1 > 0) {
                    cblas_zswap(k - kp - 1, &A[(kp + 1) + k * lda], 1,
                                &A[kp + (kp + 1) * lda], lda);
                }
        ...
        while (k >= 0) {
            ...
            if (kp != k) {
                ...
                if (kp - k - 1 > 0) {
                    cblas_zswap(kp - k - 1, &A[(k + 1) + k * lda], 1,
                                &A[kp + (k + 1) * lda], lda);
                }
