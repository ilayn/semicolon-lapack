/**
 * @file zlasyf.c
 * @brief ZLASYF computes a partial factorization of a complex symmetric matrix
        ...
        while (1) {
            ...
            if (fmax(absakk, colmax) == 0.0) {
                ...
                if (absakk >= ALPHA_BK * colmax) {
                    ...
                    cblas_zcopy(imax + 1, &A[0 + imax * lda], 1,
                                &W[0 + (kw - 1) * ldw], 1);
                    ...
                    if (absakk >= ALPHA_BK * colmax * (colmax / rowmax)) {
                        /* No interchange, use 1-by-1 pivot block */
                        kp = k;
                    } else if (cabs1(W[imax + (kw - 1) * ldw]) >= ALPHA_BK * rowmax) {
        ...
        while (1) {
            ...
            if (fmax(absakk, colmax) == 0.0) {
                ...
                if (absakk >= ALPHA_BK * colmax) {
                    ...
                    cblas_zcopy(n - imax, &A[imax + imax * lda], 1,
                                &W[imax + (k + 1) * ldw], 1);
                    ...
                    if (absakk >= ALPHA_BK * colmax * (colmax / rowmax)) {
                        /* No interchange, use 1-by-1 pivot block */
                        kp = k;
                    } else if (cabs1(W[imax + (k + 1) * ldw]) >= ALPHA_BK * rowmax) {
                        /* Interchange rows and columns K and IMAX,
                         * use 1-by-1 pivot block.
