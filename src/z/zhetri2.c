/**
 * @file zhetri2.c
 * @brief ZHETRI2 computes the inverse of a COMPLEX*16 hermitian indefinite
 *        matrix A using the factorization computed by ZHETRF.
 */
 ...
 * ZHETRF. ZHETRI2 sets the LEADING DIMENSION of the workspace
