/**
 * @file zhetrs_rook.c
 * @brief ZHETRS_ROOK solves a system of linear equations A*X = B with a
 *        complex Hermitian matrix A using the factorization computed by
 *        ZHETRF_ROOK.
 */
 ...
 *                      to obtain the factor U or L as computed by ZHETRF_ROOK.
