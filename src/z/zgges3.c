/**
 * @file zgges3.c
 * @brief ZGGES3 computes the eigenvalues, the Schur form, and, optionally,
            ...
            double* rwork, int* bwork, int* info)
{
    ...
    *info = 0;
    ...
    zgghd3(jobvsl, jobvsr, n, ilo, ihi, A, lda, B, ldb, VSL,
           ldvsl, VSR, ldvsr, &work[iwrk], lwork - iwrk, &ierr);

    *sdim = 0;

    iwrk = itau;
    zlaqz0("S", jobvsl, jobvsr, n, ilo, ihi, A, lda, B, ldb,
